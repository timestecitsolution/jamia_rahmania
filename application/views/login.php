        ...
        <section class="auth bg-base d-flex flex-wrap">
            ...
            <div class="auth-right p-2 px-24 d-flex flex-column justify-content-center text-center">
                <div class="max-w-464-px mx-auto w-100">
                     ...
                     <?php  if(UPLOAD_PATH.'logo/'.$this->global_setting->brand_logo){ ?>
                        <img  src="<?php echo UPLOAD_PATH.'logo/'.$this->global_setting->brand_logo; ?>" style="max-width: 100px;" alt="" class="mb-5">
                    <?php }else{ ?>
                        <img  width="100" height="100" src="<?php echo IMG_URL; ?>/sms-logo.png" class="mb-5">
                    <?php } ?> 
