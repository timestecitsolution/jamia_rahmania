        ...
        <div class="navbar nav_title" style="border: 0;">
            <a href="<?php echo site_url('dashboard/index'); ?>">
                <?php if($this->global_setting->brand_name){ ?>
                    <span style="margin-top:10px;" <?php if(str_word_count($this->global_setting->brand_name) == 1 )  ?>>
                        <img src="<?php echo UPLOAD_PATH.'logo/'.$this->global_setting->brand_logo; ?>" width="50" >
                    </span>
                <?php }else{ ?>
                ...
                <?php if($this->global_setting->brand_logo){ ?>
                     <img src="<?php echo IMG_URL; ?>/q-favicon.png" width="60" >
                <?php }else{ ?>
                     <img src="<?php echo IMG_URL; ?>/q-favicon.png" width="60" >
                <?php } ?>
            </a>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">                    
                    ...
                    <!--        <li><a  href="<?php echo site_url('theme/index'); ?>"><i class="fa fa-cubes"></i> <?php echo $this->lang->line('theme'); ?></a></li> -->
                    <!--<?php } ?>  -->
                    
                    <?php if(has_permission(VIEW, 'language', 'language')){ ?>
                        <li><a  href="<?php echo site_url('language/index'); ?>"><i class="fa fa-language"></i> <?php echo $this->lang->line('language'); ?></a></li>
                    <?php } ?>
                    ...
                    <?php if(has_permission(VIEW, 'teacher', 'teacher') || 
                        ...
                        <li><a><i class="fa fa-users"></i> <?php echo $this->lang->line('teacher'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                    ...
                    <?php if(has_permission(VIEW, 'student', 'type') || 
                           ...
                           <li><a><i class="fa fa-group"></i> <?php echo $this->lang->line('manage_student'); ?> <span class="fa fa-chevron-down"></span></a>
                               <ul class="nav child_menu">
                                    ...
                                    <?php } ?> 
                                    <?php if($this->session->userdata('role_id') == SUPER_ADMIN){ ?>
                                         <li><a href="<?php echo site_url('student/birthday/add'); ?>"> <?php echo $this->lang->line('birthday'); ?></a></li>
                                    <?php } ?>
                    ...
                    <?php } ?> 
                        ...
                        <!--<li><a><i class="fa fa-mouse-pointer"></i> <?php echo $this->lang->line('online_exam'); ?><span class="fa fa-chevron-down"></span></a>-->
                        <!--    <ul class="nav child_menu">-->
                        <!--        <?php if(has_permission(VIEW, 'onlineexam', 'instruction')){ ?>-->
                    ...
                    <?php if(has_permission(VIEW, 'exam', 'mark') || 
                               has_permission(VIEW, 'exam', 'mark_print') || 
                        ...
                        <li><a><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('exam_mark'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                ...
                                <?php } ?>
                                <?php if(has_permission(VIEW, 'exam', 'mark')){ ?>
                                    <li><a href="<?php echo site_url('exam/mark/mark_print'); ?>">Mark Print</a></li>
                                <?php } ?>
                    ...
                    <?php if(has_permission(VIEW, 'inventory', 'supplier') || 
                        ...
                        <li><a><i class="fa fa-users"></i> <?php echo $this->lang->line('inventory'); ?><span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <?php if(has_permission(VIEW, 'inventory', 'supplier')){ ?>
                    ...
                    <?php if(has_permission(VIEW, 'asset', 'vendor') || 
                        ...
                        <li><a><i class="fa fa-users"></i> <?php echo $this->lang->line('asset_management'); ?><span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <?php if(has_permission(VIEW, 'asset', 'vendor')){ ?>
                   ...
                   <?php } ?>
                    ...
                    <?php if(has_permission(VIEW, 'scholarship', 'scholarship') || 
                        ...
                        <!--<li><a><i class="fa fa-users"></i> <?php echo $this->lang->line('scholarship'); ?><span class="fa fa-chevron-down"></span></a>-->
                        <!--    <ul class="nav child_menu">-->
                    ...
                    <?php } ?>
                        ...
                        <?php if(has_permission(VIEW, 'donation', 'collection') || 
                            has_permission(VIEW, 'donation', 'doner')){ ?>    
                        <li><a><i class="fa fa-users"></i> <?php echo $this->lang->line('donation'); ?><span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu"> 
                                <?php if(has_permission(VIEW, 'donation', 'doner')){ ?>
                                    <li><a href="<?php echo site_url('donation/doner/index'); ?>"><?php echo $this->lang->line('doner'); ?></a></li>                         
                                <?php } ?>
                                <?php if(has_permission(VIEW, 'donation', 'collection')){ ?>
                                    <li><a href="<?php echo site_url('donation/collection/index'); ?>"><?php echo $this->lang->line('collection'); ?></a></li>                         
                                <?php } ?>                                                               
                            </ul>
                        </li> 
                    <?php } ?>
                            ...
                            <ul class="nav child_menu">
                               ...
                               <?php if(has_permission(VIEW, 'accounting', 'feetype')){ ?>
                                ...
                                <?php //if(has_permission(VIEW, 'accounting', 'donation')){ ?>
                                    <!--<li><a href="<?php echo site_url('accounting/Donation/index'); ?>"><?php echo $this->lang->line('donation_head'); ?></a></li> -->
                                    <!--<li><a href="<?php echo site_url('accounting/income/index'); ?>"><?php echo $this->lang->line('donation'); ?></a></li> -->
                                <?php //} ?>
                    ...
                    <?php if(has_permission(VIEW, 'report', 'report')){ ?>
                        <li><a><i class="fa fa-bar-chart"></i> <?php echo $this->lang->line('report'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                ...
                                <li><a href="<?php echo site_url('report/donation'); ?>"><?php echo $this->lang->line('donation_report'); ?></a></li> 
                                <li><a href="<?php echo site_url('report/construction'); ?>"><?php echo $this->lang->line('construction_report'); ?></a></li> 
                                ...
                                <li><a href="<?php echo site_url('report/tabulation'); ?>">Tabulation Sheet</a></li>
                            </ul>
                        </li> 
                    <?php } ?>
                   ...
                   <?php if(has_permission(VIEW, 'gallery', 'gallery') || has_permission(VIEW, 'gallery', 'image')){ ?>     
                    <li><a><i class="fa fa-image"></i><?php echo $this->lang->line('media_gallery'); ?> <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                           ...
                           <?php } ?>
                           <?php if(has_permission(VIEW, 'gallery', 'gallery_video')){ ?>      
                                <li><a href="<?php echo site_url('gallery/Video/index'); ?>"><?php echo $this->lang->line('gallery_video'); ?></a></li>
                           <?php } ?>
                        </ul>
                    </li> 
                    <?php } ?> 
                    ...
                    <li><a><i class="fa fa-desktop"></i><?php echo $this->lang->line('manage_frontend'); ?> <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            ...
                            <?php } ?>   
                            <?php if(has_permission(VIEW, 'frontend', 'superintendent_message')){ ?>
                                <li><a href="<?php echo site_url('frontend/superintendent_message/index'); ?>"><?php echo $this->lang->line('muhtamim_message'); ?></a></li>
                            <?php } ?>
                            <?php if(has_permission(VIEW, 'frontend', 'founder_director_message')){ ?>
                                <li><a href="<?php echo site_url('frontend/founder_director_message/index'); ?>"><?php echo $this->lang->line('founder_director_message'); ?></a></li>
                            <?php } ?>
                        </ul>
                    </li>  
                    <?php } ?>
                ...
                <?php if($this->session->userdata('role_id') == SUPER_ADMIN){ ?>    
                    <!--<li><a><i class="fa fa-thumbs-o-up"></i><?php echo $this->lang->line('subscription'); ?> (SaaS) <span class="fa fa-chevron-down"></span></a>-->
                    <!--    <ul class="nav child_menu">-->
                    ...
                    <!--        <li><a href="<?php echo site_url('subscription/setting/index'); ?>"><?php echo $this->lang->line('subscription_setting'); ?></a></li>-->
                    <!--        <li><a href="<?php echo site_url('administrator/setting/index'); ?>"> <?php echo $this->lang->line('general_setting'); ?></a></li>-->
                    <!--        <li><a href="<?php echo site_url('subscription/plan/index'); ?>"><?php echo $this->lang->line('subscription_plan'); ?></a></li>-->
                    <!--        <li><a href="<?php echo site_url('subscription/index'); ?>"><?php echo $this->lang->line('subscription'); ?></a></li>-->
                    <!--    </ul>-->
                    <!--</li> -->
                <?php } ?>     
