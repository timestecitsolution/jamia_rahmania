...
// $config['base_url'] = 'http://localhost:8080/main/';
...
define('SMS', 'Qwami - Shikkha Management System');
define('FROM_EMAIL', 'info@proggya.com');
define('FROM_NAME', 'Qwami - Shikkha Management System');
