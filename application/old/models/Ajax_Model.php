...
class Ajax_Model extends MY_Model {
    ...
    public function get_student_list($class_id, $school_id, $academic_year_id,$subject_id=null, $section_id=null){
        if(!empty($subject_id))
        {
    ...
    public function get_student_list_absent($class_id, $school_id, $academic_year_id,$subject_id=null,$absent_date=null, $section_id=null){
        $absent_date = explode("-", $absent_date);
        $day = (int)$absent_date[0];
        $month = $absent_date[1];
        $year = $absent_date[2];
        $day = 'day_'.$day;
        ...
        $this->db->from('enrollments AS E');        
        $this->db->join('students AS S', 'S.id = E.student_id', 'left');
        $this->db->join('student_attendances AS SA', 'SA.student_id = S.id', 'left');
