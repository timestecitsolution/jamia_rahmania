...
class Student_Model extends MY_Model {
    ...
    public function get_student_list_trash($class_id = null, $school_id = null, $academic_year_id = null){
    ...
    public function get_section($class_id = null, $school_id = null)
    {
        if(!$class_id){
            return;
        }
        ...
        if($school_id){
            $this->db->where('SE.school_id', $school_id); 
        }
    ...
    public function get_invoice_list($school_id, $student_id){
        ...
        $this->db->where('I.user_id', $student_id);  // stuswent user id 
