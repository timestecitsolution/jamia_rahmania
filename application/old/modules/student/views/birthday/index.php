                ...
                <div class="" data-example-id="togglable-tabs">
                        ...
                        <li class="li-class-list">
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                                <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_sms_by_school(this.value);">
                                        <option value="<?php echo site_url('student/birthday/index'); ?>">--<?php echo $this->lang->line('select_school'); ?>--</option> 
                                    <?php foreach($schools as $obj ){ ?>
                                        <option value="<?php echo site_url('student/birthday/index/'.$obj->id); ?>" <?php if(isset($filter_school_id) && $filter_school_id == $obj->id){ echo 'selected="selected"';} ?> > <?php echo $obj->school_name; ?></option>
                                    <?php } ?>   
                                </select>
                            <?php } ?>  
                        </li>
                    ...
                    <div class="tab-content">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if(has_permission(DELETE, 'message', 'text')){ ?>
                                                    <a href="<?php echo site_url('student/birthday/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_sms">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('student/birthday/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="role_id"  id="role_id" required="required" onchange="get_user_by_role(this.value, '');">
                                            ...
                                            <?php if(isset($roles) && !empty($roles)){ ?>
                                                ...
                                                if($obj->slug == "teacher" || $obj->slug == "student")
                                                {?>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('student/birthday/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
...
<script type="text/javascript">
    ...
    function get_sms_modal(sms_id){
        ...
        $.ajax({       
          type   : "POST",
          url    : "<?php echo site_url('student/birthday/get_single_sms'); ?>",
          data   : {sms_id : sms_id},  
 ...
 <script type="text/javascript">
  ...
  <?php if(isset($message)){ ?>
   ...
   function get_user(role_id, class_id, user_id){
       ...
       $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('ajax/get_user_by_role_birthday'); ?>",
