<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-thumbs-o-up"></i><small> <?php echo $this->lang->line('manage_subscription'); ?></small></h3>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="#tab_plan_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if(has_permission(ADD, 'subscription', 'plan')){ ?>
                            <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="#tab_add_plan"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                        <?php } ?>
                        <?php if(isset($edit)){ ?>
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_plan_list" >
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($subscriptions) && !empty($subscriptions)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if(has_permission(EDIT, 'subscription', 'subscription')){ ?>
                                                    <a href="<?php echo site_url('subscription/edit/'.$obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_plan">
                            <div class="x_content"> 
                               ...
                               <?php echo form_open(site_url('subscription/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12" name="subscription_plan_id" id="edit_subscription_plan_id" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($plans as $obj){ ?>
                                                    <option value="<?php echo $obj->id; ?>" <?php echo isset($post) && $post['subscription_plan_id'] == $obj->id ?  'selected="selected"' : ''; ?>><?php echo $this->lang->line($obj->plan_name); ?></option>
                                                <?php } ?>
                                            </select>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="name"  id="edit_name" value="<?php echo isset($post) ?  $post['name'] : ''; ?>" placeholder="<?php echo $this->lang->line('name'); ?>" required="required" type="text">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="email"  id="edit_email" value="<?php echo isset($post) ?  $post['email'] : ''; ?>" placeholder="<?php echo $this->lang->line('email'); ?>" required="required" type="email">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="add_phone" value="<?php echo isset($post) ?  $post['phone'] : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?>" required="required" type="number">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="address"  id="edit_address" value="<?php echo isset($post) ?  $post['address'] : ''; ?>" placeholder="<?php echo $this->lang->line('address'); ?>" required="required" type="text">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12" name="subscription_status" id="edit_subscription_status" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="pending" <?php if(isset($post['subscription_status']) && $post['subscription_status'] == 'pending'){ echo 'selected="selected"'; } ?>><?php echo $this->lang->line('pending'); ?></option>                                           
                                                <option value="approved" <?php if(isset($post['subscription_status']) && $post['subscription_status'] == 'approved'){ echo 'selected="selected"'; } ?>><?php echo $this->lang->line('approved'); ?></option>                                           
                                                <option value="suspend" <?php if(isset($post['subscription_status']) && $post['subscription_status'] == 'suspend'){ echo 'selected="selected"'; } ?>><?php echo $this->lang->line('suspend'); ?></option>                                           
                                                <option value="expired" <?php if(isset($post['subscription_status']) && $post['subscription_status'] == 'expired'){ echo 'selected="selected"'; } ?>><?php echo $this->lang->line('expired'); ?></option>                                           
                                            </select>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_plan">
                            <div class="x_content">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12" name="subscription_plan_id" id="edit_subscription_plan_id" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($plans as $obj){ ?>
                                                    <option value="<?php echo $obj->id; ?>" <?php echo isset($obj->id) && $obj->id == $subscription->subscription_plan_id ?  'selected="selected"' : ''; ?>><?php echo $this->lang->line($obj->plan_name); ?></option>
                                                <?php } ?>
                                            </select>
                                        <div class="help-block"><?php echo form_error('subscription_plan_id'); ?></div>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="plan_price"  id="edit__plan_price" value="<?php echo isset($subscription) ?  $subscription->plan_price : ''; ?>" placeholder="<?php echo $this->lang->line('price'); ?>" required="required" type="number">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"><?php echo $this->lang->line('name'); ?> <span class="required">*</span> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="name"  id="edit_name" value="<?php echo isset($subscription) ?  $subscription->name : ''; ?>" placeholder="<?php echo $this->lang->line('name'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('name'); ?></div>
                                    </div>
                                </div> 
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email"><?php echo $this->lang->line('email'); ?> <span class="required">*</span> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="email"  id="edit_email" value="<?php echo isset($subscription) ?  $subscription->email : ''; ?>" placeholder="<?php echo $this->lang->line('email'); ?>" required="required" type="email">
                                        <div class="help-block"><?php echo form_error('email'); ?></div>
                                    </div>
                                </div> 
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="phone"><?php echo $this->lang->line('phone'); ?> <span class="required">*</span> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="add_phone" value="<?php echo isset($subscription) ?  $subscription->phone : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?>" required="required" type="number">
                                        <div class="help-block"><?php echo form_error('phone'); ?></div>
                                    </div>
                                </div>   
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="address"><?php echo $this->lang->line('address'); ?> <span class="required">*</span> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="address"  id="edit_address" value="<?php echo isset($subscription) ?  $subscription->address : ''; ?>" placeholder="<?php echo $this->lang->line('address'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('address'); ?></div>
                                    </div>
                                </div>   
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12" name="subscription_status" id="edit_subscription_status" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="pending" <?php if(isset($subscription->subscription_status) && $subscription->subscription_status == 'pending'){ echo 'selected="selected"'; } ?>><?php echo $this->lang->line('pending'); ?></option>                                           
                                                <option value="approved" <?php if(isset($subscription->subscription_status) && $subscription->subscription_status == 'approved'){ echo 'selected="selected"'; } ?>><?php echo $this->lang->line('approved'); ?></option>                                           
                                                <option value="suspend" <?php if(isset($subscription->subscription_status) && $subscription->subscription_status == 'suspend'){ echo 'selected="selected"'; } ?>><?php echo $this->lang->line('suspend'); ?></option>                                           
                                                <option value="expired" <?php if(isset($subscription->subscription_status) && $subscription->subscription_status == 'expired'){ echo 'selected="selected"'; } ?>><?php echo $this->lang->line('expired'); ?></option>                                           
                                            </select>
                                        <div class="help-block"><?php echo form_error('status'); ?></div>
                                    </div>
                                </div>  
