<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bullhorn"></i><small> <?php echo $this->lang->line('manage_faq'); ?></small></h3>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(has_permission(ADD, 'miscellaneous', 'faq')){ ?>
                        ...
                        <?php } ?>                
                        <?php if(isset($detail)){ ?>
                            <li  class="active"><a href="#tab_view_faq"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?></a> </li>                          
                        <?php } ?> 
                        
                        <li class="li-class-list">
                           <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                                <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_faq_by_school(this.value);">
                                        <option value="<?php echo site_url('miscellaneous/faq/index'); ?>">--<?php echo $this->lang->line('select_school'); ?>--</option> 
                                    <?php foreach($schools as $obj ){ ?>
                                        <option value="<?php echo site_url('miscellaneous/faq/index/'.$obj->id); ?>" <?php if(isset($filter_school_id) && $filter_school_id == $obj->id){ echo 'selected="selected"';} ?> > <?php echo $obj->school_name; ?></option>
                                    <?php } ?>   
                                </select>
                            <?php } ?>  
                        </li>                            
                    ...
                    <div class="tab-content">
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($faqs) && !empty($faqs)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(EDIT, 'miscellaneous', 'faq')){ ?>
                                                    <a href="<?php echo site_url('miscellaneous/faq/edit/'.$obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'miscellaneous', 'faq')){ ?>
                                                    <a href="<?php echo site_url('miscellaneous/faq/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_faq">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('miscellaneous/faq/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('miscellaneous/faq/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_faq">
                            <div class="x_content">
                                ...
                                <?php echo form_open(site_url('miscellaneous/faq/edit/'.$faq->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
 ...
 <script type="text/javascript">
    ...
    function get_faq_by_school(url){          
        if(url){
