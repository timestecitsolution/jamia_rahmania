                                    ...
                                    <?php $count = 1; if(isset($non_members) && !empty($non_members)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="col-md-12 col-xs-12" >
                                                    <select  class="select2_mamun form-control col-md-7 col-xs-12 alignleft" name="hostel_id" id="hostel_id_<?php echo $obj->user_id; ?>" onchange="get_room_by_hostel(this.value, '<?php echo $obj->user_id; ?>');" required="required">
                                                ...
                                                <div class="col-md-12 col-xs-12" >
                                                    <select  class="select2_mamun form-control col-md-7 col-xs-12" name="room_id" id="room_id_<?php echo $obj->user_id; ?>" required="required">
