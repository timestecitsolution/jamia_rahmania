                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php } ?> 
                            ...
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                            
                                <select  class="select2_mamun form-control col-md-7 col-xs-12 auto-width" name="school_id_filter" id="school_id_filter" onchange="get_visitor_by_school(this.value,'')">
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($visitors) && !empty($visitors)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php $user = get_user_by_role($obj->role_id, $obj->user_id);  if(!empty($user)){ echo $user->name; ?><br/> [ <?php echo $obj->role; ?> ] <?php } ?> </td>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontoffice/visitor/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="purpose_id"  id="add_purpose_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontoffice/visitor/edit/'.$visitor->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="role_id"  id="edit_role_id" required="required" onchange="get_user_by_role(this.value, '<?php echo $visitor->user_id; ?>');">
                                             <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                             <?php if(isset($roles) &&  !empty($roles)){ ?>
                                                <?php foreach($roles as $obj ){ ?>
                                                    <?php if(!in_array($obj->id, array(GUARDIAN, SUPER_ADMIN))){ ?>
                               ...
                               <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="purpose_id"  id="edit_purpose_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php if(isset($purposes) && !empty($purposes)){ ?>
                                                <?php foreach($purposes as $obj){ ?>
