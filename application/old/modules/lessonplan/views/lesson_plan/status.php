                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div  class="fn_lesson_container">
                                                    ...
                                                    <select  class="select2_mamun form-control col-md-7 col-xs-12 gsms-nice-select_" onchange="update_lesson_status(this.value, '<?php echo $obj->lesson_detail_id; ?>');" style="width: auto;">
                                            ...
                                            <td>                                                
                                                ...
                                                <?php foreach($topic_list AS $td){ ?>
                                                    <div  class="fn_topic_container">
                                                         ...
                                                         <select  class="select2_mamun form-control col-md-7 col-xs-12 gsms-nice-select_"  onchange="update_topic_status(this.value, '<?php echo $td->id; ?>');" style="width: auto;">
                                                            <?php foreach($lesson_status AS $key=>$value){ ?>
