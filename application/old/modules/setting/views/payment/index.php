                        ...
                        <div class="tab-pane fade in <?php echo isset($jazzcash) ? 'active':''; ?>" id="tab_jazzcash_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="jaz_demo" id="stack_demo" required="required">
                        ...
                        <div class="tab-pane fade in <?php echo isset($sslcommerz) ? 'active':''; ?>" id="tab_sslcommerz_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="ssl_demo" id="ssl_demo" required="required">
                        ...
                        <div class="tab-pane fade in <?php echo isset($midtrans) ? 'active':''; ?>" id="tab_midtrans_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="mid_demo" id="stack_demo" required="required">
                                            <option value="1" <?php if(isset($setting) && $setting->jaz_demo == '1'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('yes'); ?></option>
                                            <option value="0" <?php if(isset($setting) && $setting->jaz_demo == '0'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('no'); ?></option>
                                        </select>
                        ...
                        <div class="tab-pane fade in <?php echo isset($instamojo) ? 'active':''; ?>" id="tab_instamojo_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="mojo_demo" id="ssl_demo" required="required">
                        ...
                        <div class="tab-pane fade in <?php echo isset($flutter) ? 'active':''; ?>" id="tab_flutter_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="flut_demo" id="flut_demo" required="required">
                        ...
                        <div class="tab-pane fade in <?php echo isset($ipay) ? 'active':''; ?>" id="tab_ipay_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="ipay_demo" id="ipay_demo" required="required">
                        ...
                        <div class="tab-pane fade in <?php echo isset($billplz) ? 'active':''; ?>" id="tab_billplz_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="bill_demo" id="bill_demo" required="required">
