                     ...
                     <div class="tab-content">
                         <div class="tab-pane fade in active"id="tab_setting">
                            <div class="x_content"> 
                                ...
                                <div class="fn_edit_smtp <?php if(isset($email_setting) && $email_setting->mail_protocol != 'smtp' || empty($email_setting)){ echo 'display'; } ?>"> 
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <button id="send" type="submit" class="btn btn-success"><?php  echo $this->lang->line($action == 'add' ? 'submit' : 'update'); ?></button>
                                    </div>
                                </div>
