                    ...
                    <ul  class="nav nav-tabs bordered">                     
                        ...
                        <li  class="<?php echo isset($bulkpk) || isset($cluster) || isset($alpha) || isset($bdbulk) || isset($mimsms) ? 'active':''; ?> dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="<?php echo isset($bulk360) ? 'active':''; ?>"><a href="#tab_bulk360_setting" role="tab" data-toggle="tab"><?php echo $this->lang->line('bulk_360'); ?></a></li>
                                <li class="<?php echo isset($smsto) ? 'active':''; ?>"><a href="#tab_smsto_setting" role="tab" data-toggle="tab"><?php echo $this->lang->line('sms_to'); ?></a></li>
                            </ul>
                        </li>                          
                    </ul>
                    <br/>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in <?php echo isset($clickatell) ? 'active':''; ?>" id="tab_clickatell_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="clicktelurl">&nbsp;</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="tab-pane fade in <?php echo isset($twilio) ? 'active':''; ?>" id="tab_twilio_setting">
                             <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="twilowurl">&nbsp;</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="tab-pane fade in <?php echo isset($bulk360) ? 'active':''; ?>" id="tab_bulk360_setting">
                            <div class="x_content"> 
                                <?php echo form_open_multipart(site_url('setting/sms/bulk360'), array('name' => 'bulk360', 'id' => 'bulk360', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                <input type="hidden" value="<?php echo isset($setting) ? $setting->id : ''; ?>" name="id" />
                                 <input type="hidden" value="1" name="bulk360" />
                                 <input class="fn_school_id" type="hidden" name="school_id" id="edit_school_id" value="<?php echo $this->session->userdata('school_id'); ?>" />
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="bulk360_username" value="<?php echo isset($setting) ? $setting->bulk360_username : ''; ?>"  placeholder="<?php echo $this->lang->line('username'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="bulk360_password" value="<?php echo isset($setting) ? $setting->bulk360_password : ''; ?>"  placeholder="<?php echo $this->lang->line('password'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="bulk360_from_no" value="<?php echo isset($setting) ? $setting->bulk360_from_no : ''; ?>"  placeholder="<?php echo $this->lang->line('from_number'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="bulk360_status" required="required">
                                            <option value="1" <?php if(isset($setting) && $setting->bulk360_status == '1'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('yes'); ?></option>
                                            <option value="0" <?php if(isset($setting) && $setting->bulk360_status == '0'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('no'); ?></option>
                                        </select>
                               ...
                               <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="360url">&nbsp;</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="tab-pane fade in <?php echo isset($smsto) ? 'active':''; ?>" id="tab_smsto_setting">
                            <div class="x_content"> 
                                <?php echo form_open_multipart(site_url('setting/sms/smsto'), array('name' => 'smsto', 'id' => 'smsto', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                <input type="hidden" value="<?php echo isset($setting) ? $setting->id : ''; ?>" name="id" />
                                 <input type="hidden" value="1" name="smsto" />
                                 <input class="fn_school_id" type="hidden" name="school_id" id="edit_school_id" value="<?php echo $this->session->userdata('school_id'); ?>" />
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="smsto_api_key" value="<?php echo isset($setting) ? $setting->smsto_api_key : ''; ?>"  placeholder="<?php echo $this->lang->line('api_key'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="smsto_sender_id" value="<?php echo isset($setting) ? $setting->smsto_sender_id : ''; ?>"  placeholder="<?php echo $this->lang->line('sender_id'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="smsto_status" required="required">
                                            <option value="1" <?php if(isset($setting) && $setting->smsto_status == '1'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('yes'); ?></option>
                                            <option value="0" <?php if(isset($setting) && $setting->smsto_status == '0'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('no'); ?></option>
                                        </select>
