                        ...
                        <?php } ?>                
                            ...
                            <li class="li-class-list"> 
                                ...
                                <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>
                                    ...
                                    <select  class="select2_mamun form-control col-md-7 col-xs-12" style="width:auto;" name="school_id" id="filter_school_id" onchange="get_class_by_school(this.value, '', '');">
                                 ...
                                 <?php } ?>
                                    <select  class="select2_mamun form-control col-md-7 col-xs-12 gsms-nice-select_" name="class_id" id="filter_class_id" onchange="get_subject_by_class(this.value, '', '');" style="width: auto;">
                                    ...
                                    <select  class="select2_mamun form-control col-md-7 col-xs-12 gsms-nice-select_" name="subject_id" id="filter_subject_id" onchange="get_online_exam_by_subject(this.value, '', '`');" style="width: auto;">                                
                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                    </select> 
                                    <select  class="select2_mamun form-control col-md-7 col-xs-12 gsms-nice-select_" name="online_exam_id" id="filter_online_exam_id" style="width: auto;"> 
                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                   
                                    </select> 
