                        ...
                        <?php } ?>                
                            ...
                            <?php echo form_open(site_url('onlineexam/index'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>
                                    ...
                                    <select  class="select2_mamun form-control col-md-7 col-xs-12" id="class_id" name="class_id" onchange="get_subject_by_class(this.value, '', '');" style="width:auto;">
                            ...
                            <div class="x_content"> 
                               ...
                               <?php echo form_open_multipart(site_url('onlineexam/add'), array('name' => 'online_exam_add', 'id' => 'online_exam_add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12  gsms-nice-select_"  name="instruction_id"  id="add_instruction_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12  gsms-nice-select_"  name="mark_type"  id="add_mark_type" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12  gsms-nice-select_"  name="is_publish"  id="add_is_publish">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('onlineexam/edit/'.$online_exam->id), array('name' => 'online_exam_edit', 'id' => 'online_exam_edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="class_id"><?php echo $this->lang->line('class'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12 gsms-nice-select_"  name="class_id"  id="edit_class_id" required="required"  onchange="get_section_by_class(this.value, '', 'edit_');get_subject_by_class(this.value, '', 'edit_');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($classes as $obj ){ ?>
                                               <?php
                                                if($this->session->userdata('role_id') == TEACHER){
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="instruction_id"><?php echo $this->lang->line('instruction'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12  gsms-nice-select_"  name="instruction_id"  id="edit_instruction_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                            <?php foreach($instructions as $obj){ ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="mark_type"><?php echo $this->lang->line('mark_type'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12  gsms-nice-select_"  name="mark_type"  id="edit_mark_type" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                            <?php $types = get_mark_type(); ?>
                                            <?php foreach($types as $key=>$value){ ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="is_publish"><?php echo $this->lang->line('is_publish'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12  gsms-nice-select_"  name="is_publish"  id="edit_is_publish">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                ...
                                <div class="item form-group">
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12  gsms-nice-select_"  name="status"  id="edit_status">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
