        ...
        if ($_POST) {
            ...
            if (!empty($_POST['students'])) {
                ...
                foreach ($_POST['students'] as $key => $value) {
                    ...
                    {
                        $conver_written_mark = ($data['written_obtain'] / $data['written_mark']) * 100;
                    ...
                    {
                        $conver_tutorial_mark = ($data['tutorial_obtain'] / $data['tutorial_mark']) * 100;
                    ...
                    {
                        $conver_practical_mark = ($data['practical_obtain'] / $data['practical_mark']) * 100;
                        if (!empty($mark_grades) && $flag == 0) {
                            foreach ($mark_grades as $obj) {   
                    ...
                    {
                        $conver_viva_mark = ($data['viva_obtain'] / $data['viva_mark']) * 100;
                        if (!empty($mark_grades) && $flag == 0) {
                            foreach ($mark_grades as $obj) {   
