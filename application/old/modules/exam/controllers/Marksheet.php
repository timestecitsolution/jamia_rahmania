        ...
        if ($_POST) {
            ...
            if($this->session->userdata('role_id') == STUDENT){
                ...
                if(!empty($student_id))
                {
                    ...
                    $students = get_student_by_class($class_id,$school->id,$school->academic_year_id,$std->id);
                }
                else
                {
                    $students = get_student_by_class($class_id,$school->id,$school->academic_year_id);
                }
                ...
                if(!empty($students))
                {
                    foreach($students as $key=>$student)
                    {
                        ...
                        $this->data['student_id'][$key] = $student->id;
                        $this->data['subjects'][$key] = $this->mark->get_subject_list($school_id, $exam_id, $class_id, $section_id, $student->id, $school->academic_year_id);
