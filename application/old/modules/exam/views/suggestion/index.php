                        ...
                        <?php } ?>  
                            ...
                            <li class="li-class-list">                                
                                ...
                                <?php }else{  ?>
                                    ...
                                    <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_suggestion_list_by_class(this.value);">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('exam/suggestion/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="exam_id" id="add_exam_id" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('exam/suggestion/edit/'.$suggestion->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="exam_id" id="edit_exam_id" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
