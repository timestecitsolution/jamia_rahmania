            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(has_permission(ADD, 'asset', 'issue')){ ?>
                             <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('asset/issue/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> </a> </li>                          
                             <?php }else{ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="#tab_add_issue"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> </a> </li>                          
                             <?php } ?>
                        <?php } ?> 
                        <?php if(isset($edit)){ ?>
                        ...
                        <li class="li-class-list">
                           <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                                <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_issue_by_school(this.value);">
                                        <option value="<?php echo site_url('asset/issue/index'); ?>">--<?php echo $this->lang->line('select_school'); ?>--</option> 
                                    <?php foreach($schools as $obj ){ ?>
                                        <option value="<?php echo site_url('asset/issue/index/'.$obj->id); ?>" <?php if(isset($filter_school_id) && $filter_school_id == $obj->id){ echo 'selected="selected"';} ?> > <?php echo $obj->school_name; ?></option>
                                    <?php } ?>   
                                </select>
                            <?php } ?>  
                        </li>
                    ...
                    <div class="tab-content">
                                ...
                                <tbody>   
                                    ...
                                    <?php $count = 1; if(isset($issues) && !empty($issues)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date($this->global_setting->date_format, strtotime($obj->check_in_date)); ?></td>
                                            <td><?php echo $obj->check_out_date ? date($this->global_setting->date_format, strtotime($obj->check_out_date)) : '<a style="color:red;" href="javascript:void(0);" onclick="issue_check_out('.$obj->id.');">'.$this->lang->line('check_out').'</a>'; ?></td>                                           
                                            <td>                                                      
                                                ...
                                                <?php } ?>
                                                <?php if(has_permission(EDIT, 'asset', 'issue')  && !$obj->check_out_date){ ?>
                                                    <a href="<?php echo site_url('asset/issue/edit/'.$obj->id); ?>" title="<?php echo $this->lang->line('edit'); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                <?php } ?> 
                                                <?php if(has_permission(DELETE, 'asset', 'issue')){ ?>    
                                                    <a href="<?php echo site_url('asset/issue/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_issue">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('asset/issue/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="role_id"  id="add_role_id" required="required" onchange="get_user_by_role(this.value, '');">
                                ...
                                <div class="item form-group display"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="class_id"  id="add_class_id"  onchange="get_user('', this.value,'');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                ...
                                <div class="item form-group">  
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="user_id"  id="add_user_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                         
                                        </select>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="category_id"  id="add_category_id" required="required" onchange="get_item_by_category(this.value, '', 'add');" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="item_id"  id="add_item_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                         
                                        </select>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="issue_date"><?php echo $this->lang->line('issue_date'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="check_in_date"><?php echo $this->lang->line('check_in'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="check_in_date"  id="add_check_in_date" value="<?php echo isset($post['check_in_date']) ?  $post['check_in_date'] : ''; ?>" placeholder="<?php echo $this->lang->line('check_in'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('check_in_date'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('asset/issue/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
                        ...
                        <?php if(isset($edit)){ ?>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('asset/issue/edit/'.$issue->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="item form-group"> 
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="role_id"><?php echo $this->lang->line('user_type'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="role_id"  id="edit_role_id" required="required" onchange="get_user_by_role(this.value, '');">
                                                <option value="">--<?php echo $this->lang->line('select'); ?> --</option> 
                                                <?php foreach($roles as $obj ){  ?>
                                                    <?php if($this->session->userdata('role_id') != SUPER_ADMIN && $obj->id == SUPER_ADMIN ){ continue;} ?>
                                                    <?php if(in_array($obj->id, array(GUARDIAN))){ continue;} ?>
                                    ...
                                    <div class="item form-group display"> 
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="class_id"><?php echo $this->lang->line('class'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="class_id"  id="edit_class_id"  onchange="get_user('', this.value,'');">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                                <?php foreach($classes as $obj ){ ?>
                                    ...
                                    <div class="item form-group">  
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="user_id"><?php echo $this->lang->line('issue_to'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="user_id"  id="edit_user_id" required="required" >
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                         
                                            </select>
                                            <div class="help-block"><?php echo form_error('user_id'); ?></div>
                                        </div>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="category_id"><?php echo $this->lang->line('category'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="category_id"  id="edit_category_id" required="required" onchange="get_item_by_category(this.value, '', 'edit');" >
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                                <?php if(isset($catagories) && !empty($catagories)){ ?>
                                                    <?php foreach($catagories as $obj){ ?>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="item_id"  id="edit_item_id" required="required" >
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                         
                                            </select>
                                            <div class="help-block"><?php echo form_error('item_id'); ?></div>
                                        </div>
                                    ...
                                    <div class="item form-group">
                                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="check_in_date"><?php echo $this->lang->line('check_in'); ?> <span class="required">*</span> </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="check_in_date"  id="edit_check_in_date" value="<?php echo isset($issue->check_in_date) ?  date('d-m-Y', strtotime($issue->check_in_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('check_in'); ?>" required="required" type="text" autocomplete="off">
                                         <div class="help-block"><?php echo form_error('check_in_date'); ?></div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <input type="hidden" value="<?php echo isset($issue) ? $issue->item_id : ''; ?>" id="old_item_id" name="old_item_id" />
...
<script type="text/javascript">
    ...
    function get_issue_modal(issue_id){
        ...
        $.ajax({       
          type   : "POST",
          url    : "<?php echo site_url('asset/issue/get_single_issue'); ?>",
...
<script type="text/javascript">
    ...
    function get_category_by_school(form){
        ...
        if(!school_id){
         ...
         $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('asset/issue/get_category_by_school'); ?>",
...
<script type="text/javascript">
    ...
    $('#add_check_in_date').datepicker();
    $('#add_check_out_date').datepicker();
    
    $('#edit_issue_date').datepicker();
    $('#edit_check_in_date').datepicker();
    $('#edit_check_out_date').datepicker();
    
    <?php if(isset($post)){ ?>
        get_item_by_category('<?php echo $post['category_id']; ?>', '<?php echo $post['item_id']; ?>','add');
    <?php } ?>    
    <?php if(isset($issue)){ ?>
        get_item_by_category('<?php echo $issue->category_id; ?>', '<?php echo $issue->item_id; ?>', 'edit');
    <?php } ?>
    ...
    function get_item_by_category(category_id, item_id, form_mode){       
        ...
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('asset/issue/get_item_by_category'); ?>",
            data   : { school_id : school_id, category_id : category_id,  item_id : item_id},               
            async  : false,
            success: function(response){                                                   
               if(response)
               {
 ...
 <script type="text/javascript">
    ...
    function issue_check_out(issue_id){      
        ...
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('asset/issue/issue_check_out'); ?>",
            data   : { issue_id : issue_id},               
            async  : false,
            success: function(response){  
                if(response){
