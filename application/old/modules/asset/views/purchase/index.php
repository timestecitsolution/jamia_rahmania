                    ...
                    <ul  class="nav nav-tabs bordered">
                       ...
                       <li class="li-class-list">
                           <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                                <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_purchase_by_school(this.value);">
                                        <option value="<?php echo site_url('asset/purchase/index'); ?>">--<?php echo $this->lang->line('select_school'); ?>--</option> 
                                    <?php foreach($schools as $obj ){ ?>
                                        <option value="<?php echo site_url('asset/purchase/index/'.$obj->id); ?>" <?php if(isset($filter_school_id) && $filter_school_id == $obj->id){ echo 'selected="selected"';} ?> > <?php echo $obj->school_name; ?></option>
                                    <?php } ?>   
                                </select>
                            <?php } ?>  
                        </li>
                               ...
                               <?php echo form_open(site_url('asset/purchase/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="vendor_id"  id="add_vendor_id" required="required" >
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="item_id"  id="add_item_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                             
                                        </select>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="unit_type"  id="unit_type">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="employee_id"  id="add_employee_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_purchase">
                            <div class="x_content">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="vendor_id"><?php echo $this->lang->line('vendor'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="vendor_id"  id="edit_vendor_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php if(isset($vendors) && !empty($vendors)){ ?>
                                                <?php foreach($vendors as $obj){ ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="item_id"><?php echo $this->lang->line('asset'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="item_id"  id="edit_item_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                             
                                        </select>
                                        <div class="help-block"><?php echo form_error('item_id'); ?></div>
                                    </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="employee_id"><?php echo $this->lang->line('purchase_by'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="employee_id"  id="edit_employee_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php if(isset($employees) && !empty($employees)){ ?>
                                                <?php foreach($employees as $obj){ ?>
...
<script type="text/javascript">
    ...
    $('.fn_school_id').on('change', function(){
        ...
        <?php if(isset($purchase) && !empty($purchase)){ ?>
            ...
            vendor_id =  '<?php echo $purchase->vendor_id; ?>';
        ...
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('asset/purchase/get_category_by_school'); ?>",
        ...
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('asset/purchase/get_vendor_by_school'); ?>",
            data   : { school_id:school_id, vendor_id: vendor_id},               
            async  : false,
            success: function(response){                                                   
                if(response)
                {  
                  if(vendor_id){
                       $('#edit_vendor_id').html(response);   
                   }else{
                       $('#add_vendor_id').html(response);   
                   }
               }
           }
       });
       ...
       $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('asset/purchase/get_employee_by_school'); ?>",
...
<script type="text/javascript">
    ...
    function get_item_by_category(category_id, item_id, form_mode){       
        ...
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('asset/purchase/get_item_by_category'); ?>",
