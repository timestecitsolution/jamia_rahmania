    ...
    public function index(){
        ...
        $this->data['students'] = '';
         ...
         if ($_POST) {
            ...
            $this->data['subjects'] = $this->db->order_by("code", "asc")->get_where('subjects', array('class_id'=>$class_id, 'school_id'=>$school_id, 'status' => 1))->result();
            $this->data['academic_year'] = $this->db->get_where('academic_years', array('id'=>$this->data['school']->academic_year_id))->row();
