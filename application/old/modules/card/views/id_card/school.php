                ...
                <div class="" data-example-id="togglable-tabs">                    
                    ...
                    <div class="tab-content">                    
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('card/schoolidsetting/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="id_no_font_size"  id="id_no_font_size" max="20" value="<?php echo isset($post['id_no_font_size']) ?  $post['id_no_font_size'] : ''; ?>" placeholder="<?php echo $this->lang->line('id_no_font_size'); ?> " type="number" autocomplete="off">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group fn_colorpicker">
                                            <input  class="form-control col-md-7 col-xs-12"  name="id_no_color"  id="id_no_color" readonly="readonly" value="<?php echo isset($post['id_no_color']) ?  $post['id_no_color'] : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('id_no_color'); ?> " type="text" autocomplete="off">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group fn_colorpicker">
                                            <input  class="form-control col-md-7 col-xs-12"  name="id_no_bg"  id="id_no_bg" readonly="readonly" value="<?php echo isset($post['id_no_bg']) ?  $post['id_no_bg'] : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('id_no_background'); ?> " type="text" autocomplete="off">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="bottom_text"  id="bottom_text" value="<?php echo isset($post['bottom_text']) ?  $post['bottom_text'] : 'e01ab5'; ?>" required="required" placeholder="<?php echo $this->lang->line('bottom_signature'); ?> " type="text" autocomplete="off">
                        ...
                        <div  class="tab-pane fade in <?php if(!empty($setting)){ echo 'active'; }?>" id="tab_edit_setting">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('card/schoolidsetting/edit/'.$setting->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
