...
class Issue extends MY_Controller {
    ...
    * ********************************************************** */
    public function delete($id = null) {
        ...
        $issue = $this->book->get_single('book_issues', array('id' => $id));
        if ($this->book->delete('book_issues', array('id' => $id))) {

            success($this->lang->line('delete_success'));
        } else {
            error($this->lang->line('delete_failed'));
        }
        redirect('library/issue/index/'.$issue->school_id);
    }
