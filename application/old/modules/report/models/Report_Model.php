...
class Report_Model extends MY_Model {
    ...
    public function get_student_fee_collection_report($school_id, $academic_year_id, $class_id, $user_id, $date_from, $date_to,$income_head = null){
        ...
        $this->db->select('T.*, T.note,ST.name AS student, C.name AS class_name, IH.title AS fee_type, I.id AS inv_id, AY.session_year,I.month as month, I.custom_invoice_id AS custom_invoice_id');
