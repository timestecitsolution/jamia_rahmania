    ...
    * ********************************************************** */
    public function duefee() {
        ...
        if ($_POST) {
            ...
            $this->data['sbalance'] = $this->report->get_student_due_fee_report($school_id, $academic_year_id, $class_id, $user_id);
    ...
    * ********************************************************** */
    public function feecollection() {
        ...
        if ($_POST) {
            ...
            $this->data['feecollection'] = $this->report->get_student_fee_collection_report($school_id, $academic_year_id, $class_id, $user_id, $date_from, $date_to);
        }
