...
class Rating extends MY_Controller {
    ...
    public function manage() {
        ...
        if($school_id){
            ...
            $this->data['ratings'] = $this->rating->get_teacher_rating_list_class_subjectwise($school_id, $school->academic_year_id, $teacher_id,$month_year); 
    ...
    public function save_rating() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $message = array(
                ...
                'rating1' => form_error('rating1'),
                'rating2' => form_error('rating2'),
            ...
            $data['rating1'] = $this->input->post('rating1');
            $data['rating2'] = $this->input->post('rating2');
            $data['comment'] = $this->input->post('comment');
            $data['rating_status'] = 'approved';
            $data['status'] = 1;
    ...
    public function view_rating($teacher_id = null, $class_id = null, $section_id = null, $subject_id = null, $month = null)
    {
        ...
        $this->data['rating_list'] = $this->rating->get_rating_list($teacher_id, $class_id, $section_id, $subject_id, $month, $academic_year_id);

        $this->data['school_id'] = $school_id;   
        $this->data['schools'] = $this->schools;
        $this->data['list'] = TRUE;
        $this->layout->title($this->lang->line('manage_rating'). ' | ' . SMS);
        $this->layout->view('rating/single-rating-list', $this->data);  
    }
