                         ...
                         <li class="li-class-list">
                           ...
                           <?php echo form_open(site_url('transport/member/add'), array('name' => 'filter', 'id' => 'filter', 'class'=>'form-horizontal form-label-left'), ''); ?>
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>
                                    ...
                                    <select  class="select2_mamun form-control col-md-7 col-xs-12" id="class_id_filter" name="class_id"  style="width:auto;" onchange="this.form.submit();">
                                         <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                         
                                    </select>
                                                                                          
                            <?php }else{  ?>
                                
                                <select  class="select2_mamun form-control col-md-7 col-xs-12" id="class_id_filter" name="class_id" onchange="this.form.submit();">
                                        ...
                                        <tr>
                                            ...
                                            <td width="25%">
                                                ...
                                                <?php if($this->session->userdata('role_id') == SUPER_ADMIN){ ?>
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12">                                                       
                                                        <select  class="select2_mamun form-control col-md-12 col-xs-12 fn_school_id" itemid="<?php echo $obj->user_id; ?>" name="school_id" id="school_id_<?php echo $obj->user_id; ?>" required="required">
                                                            <option value="">--<?php echo $this->lang->line('select_school'); ?>--</option>
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12"> 
                                                    <select  class="select2_mamun form-control col-md-12 col-xs-12" name="route_id" id="route_id_<?php echo $obj->user_id; ?>"  onchange="get_bus_stop_by_route(this.value, '<?php echo $obj->user_id; ?>');"  required="required">
                                                    ...
                                                    <select  class="select2_mamun form-control col-md-7 col-xs-12" name="stop_id" id="stop_id_<?php echo $obj->user_id; ?>" required="required">
