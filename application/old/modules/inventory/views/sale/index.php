            ...
            <div class="x_content no-print">
                <div class="" data-example-id="togglable-tabs">                    
                    <ul  class="nav nav-tabs bordered">
                        <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="#tab_sale_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if(has_permission(ADD, 'inventory', 'sale')){ ?>
                             <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('inventory/sale/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> </a> </li>                          
                             <?php }else{ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="#tab_add_sale"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> </a> </li>                          
                             <?php } ?>
                        <?php } ?> 
                        <?php if(isset($edit)){ ?>
                        ...
                        <li class="li-class-list">
                           <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                                <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_sale_by_school(this.value);">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="role_id"  id="add_role_id" required="required" onchange="get_user_by_role(this.value, '', 'add');">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="income_head_id"  id="add_income_head_id"  >
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                        ...
                                        <div class="row">                  
                                           <div class="col-md-12 col-sm-12 col-xs-12">
                                               <h5  class="column-title">
                                                   ...
                                                   <a onclick="add_more_product('add');" class="btn btn-success btn-xs right" style="float: right;"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add_more'); ?> </a>
                                               </h5>
                                           </div>
                                       </div>
                                       <div class="row">
                                               ...
                                               <tbody class="fn_add_product_container"> 
                                                   ...
                                                   <tr class="fn_add_product_item">
                                                       ...
                                                       <td>
                                                           ...
                                                           <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="category_id[]"  id="add_category_id_<?php echo $unique_id; ?>" onchange="get_product_by_category(this, this.value, '', 'add'); reset_total_price(this, 'add');">
                                                               <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                                       ...
                                                       <td>
                                                           <select  class="select2_mamun form-control col-md-12 col-xs-12 fn_add_product_count"  name="product_id[]"  id="add_product_id_<?php echo $unique_id; ?>" onchange="reset_total_price(this, 'add');">
                                                               <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                         
                                                           </select>
                                                       </td>
                                                       <td>
                                           ...
                                           <div class="col-md-3 col-sm-3 col-xs-12">
                                               <div class="item form-group">
                                                   <label for="paid_status"><?php echo $this->lang->line('paid_status'); ?> <span class="required">*</span></label>
                                                    <select  class="select2_mamun form-control col-md-7 col-xs-12" name="paid_status" id="add_paid_status" required="required"  onchange="check_paid_status(this.value, 'add');">
                                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                           ...
                                           <div class="display fn_add_paid_status">
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                <div class="item form-group">
                                                    ...
                                                    <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="payment_method"  id="add_payment_method" required="required" onchange="check_payment_method(this.value, 'add');">
                                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
