                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <li class="li-class-list">
                           ...
                           <?php }else{  ?> 
                                <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_section_by_class(this.value);">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/section/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12 select2"  name="class_id"  id="add_class_id" required="required" >
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('academic/section/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
