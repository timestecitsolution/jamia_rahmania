                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(has_permission(ADD, 'academic', 'assignment')){ ?>
                            ...
                            <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('academic/assignment/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                             <?php }else{ ?>
                        ...
                        <?php } ?>                
                            ...
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>
                                ...
                                <?php echo form_open(site_url('academic/assignment/index'), array('name' => 'filter', 'id' => 'filter', 'class'=>'form-horizontal form-label-left'), ''); ?>
                            ...
                            <?php }else{  ?>
                                ...
                                <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_assignment_by_class(this.value);">
                                ...
                                <tbody>                                       
                                    <?php $count = 1; if(isset($assignments) && !empty($assignments)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date($this->global_setting->date_format, strtotime($obj->assigment_date)); ?></td>
                                            <td><?php echo date($this->global_setting->date_format, strtotime($obj->submission_date)); ?></td>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_assignment">
                            <div class="x_content"> 
                               ...
                               <div class="item form-group">
                                ...
                                <div class="item form-group">
                                     <label class="control-label col-md-3 col-sm-3 col-xs-12 chk-label" for="sms_notification"><?php echo $this->lang->line('sms_notification'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="item form-group">
                                     <label class="control-label col-md-3 col-sm-3 col-xs-12 chk-label" for="email_notification"><?php echo $this->lang->line('email_notification'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('academic/assignment/edit/'.$assignment->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="assigment_date"  id="edit_assigment_date" value="<?php echo isset($assignment->assigment_date) ?  date($this->global_setting->date_format, strtotime($assignment->assigment_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('assignment_date'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('assigment_date'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="submission_date"  id="edit_submission_date" value="<?php echo isset($assignment->submission_date) ?  date($this->global_setting->date_format, strtotime($assignment->submission_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('submission_date'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('submission_date'); ?></div>
                                    </div>
                                </div>
  ...
  $('#edit_submission_date').datepicker();
   ...
   /* Menu Filter Start */
    ...
    function get_assignment_by_class_sa(class_id){
       ...
       window.location.href = '<?php echo site_url('academic/assignment/index/'); ?>'+class_id+'/'+school_id; 
