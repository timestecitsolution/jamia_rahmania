                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($subjects) && !empty($subjects)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ucfirst($obj->group_id); ?></td>
                                            <td>
                                                <?php   
                                                    $a = "background:#8d82c1;color:#ffffff;";
                                                    $x = "Optional";

                                                    $b = "background:#45115e;color:#ffffff;";  
                                                    $y = "Non Group";

                                                    if($obj->type=='mandatory')
                                                    {
                                                        $x="Mandatory";
                                                        $a = "background:#5f4ac9;color:#ffffff;";
                                                    }
                                                    if($obj->is_group==1)
                                                    {
                                                        $y = "Group";
                                                        $b = "background:#abacd1;color:#ffffff;";  
                                                    }
                                                ?>
                                                
                                                <a class="btn  btn-xs" style=<?php echo $b; ?> > <?php echo $y; ?> </a>
                                                <a class="btn  btn-xs" style=<?php echo $a; ?> > <?php echo $x; ?> </a>
                                            </td>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/subject/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12" name="type" id="type" >
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="is_group">Is Group </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12 is_group" name="is_group" id="is_group" >
                                            
                                            <?php
                                                $is_group = ['0'=>'No','1'=>'Yes']
                                            ?>
                                            <?php foreach($is_group as $key_group=>$group){ ?>
                                                <option value="<?php echo $key_group; ?>" <?php echo isset($post['is_group']) && $post['is_group'] == $key_group ?  'selected="selected"' : ''; ?>><?php echo $group; ?></option>
                                            <?php } ?>
                                           
                                        </select>
                                        <div class="help-block"><?php echo form_error('is_group'); ?></div>
                                    </div>
                                </div>

                                <div class="display item form-group group" id="group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="group"><?php echo $this->lang->line('group'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12" name="group_id" id="add_group">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="class_id"  id="add_class_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($classes as $obj ){ ?>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_subject">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/subject/edit/'.$subject->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12 is_group" name="is_group" id="is_group" >
                                            ...
                                            ?>
                                            <?php foreach($is_group as $key_group=>$group){ ?>
                                                <option value="<?php echo $key_group; ?>" <?php if($subject->is_group == $key_group){ echo 'selected="selected"';} ?>><?php echo $group; ?></option>
                                            <?php } ?>
                                ...
                                <div class="<?php if(isset($subject->is_group) && $subject->is_group != 1){ echo 'display'; } ?> item form-group group" id="group" >
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="group"><?php echo $this->lang->line('group'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12" name="group_id" id="add_group">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="class_id"  id="edit_class_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($classes as $obj ){ ?>
