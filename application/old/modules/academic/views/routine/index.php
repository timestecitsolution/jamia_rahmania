                    ...
                    <ul  class="nav nav-tabs bordered  no-print">
                        ...
                        <li class="li-class-list">
                            <?php if($this->session->userdata('role_id') != SUPER_ADMIN){  ?> 
                                <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_subject_by_class(this.value);">
                                    ...
                                    <?php foreach($class_list as $obj ){ ?>
                                        <?php if($this->session->userdata('role_id') == STUDENT){ ?>
                                            ...
                                            <option value="<?php echo site_url('academic/routine/index/'.$obj->id); ?>" <?php if(isset($class_id) && $class_id == $obj->id){ echo 'selected="selected"';} ?> ><?php echo $obj->name; ?></option>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_routine_list" >                            
                            <div class="x_content">
                                <div class="" data-example-id="togglable-tabs">
                                    ...
                                    <?php if(isset($sections) && !empty($sections)){ ?>  
                                        <ul  class="nav nav-tabs bordered sub-tabs no-print">
                                     ...
                                     <?php if(isset($sections) && !empty($sections)){ ?>   
                                        <?php $active = ''; $other = false; $count = 0; foreach($sections as $key=>$obj){ ?>   
                                           ...
                                           <div  class="tab-pane fade in <?php if($other && $key == 0){ echo 'active'; }else{ echo $active; } ?>" id="tab_section_<?php echo $obj->id; ?>" >
                                               <div class="x_content">
                                                <input type="hidden" id="section_id_table" value="">
                                                       ...
                                                       <tbody>
                                                           ...
                                                           <?php foreach($days as $daykey=>$day){ ?>
                                                               <tr>
                                                                   ...
                                                                   <td width="100">
                                                                    <button type="button" class="btn btn-primary routine_modal" data-section-id='<?php echo $obj->id; ?>' data-day-id='<?php echo $daykey; ?>' data-toggle="modal" data-target="#exampleModal"> Add </button>
                                                                   </td>
                                                                   <td>
                                                                     ...
                                                                     <?php $routines = get_routines_by_day($daykey, $obj->class_id, $obj->id); ?>  
                                                                       ...
                                                                       <div class="btn-group">
                                                                           <button class="btn btn-default dropdown-toggle routine-text" data-toggle="dropdown" style="height:auto;">
                                                                               <?php echo $ro->start_time . ' - ' .$ro->end_time; ?><br/>
                                                                               <span style="background-color:#6291ff;color:#ffffff;padding:2px 5px; border-radius:3px">Sub: <?php echo $ro->subject; ?></span><br/>
                               ...
                               <?php echo form_open(site_url('academic/routine/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="class_id" id="add_class_id" required="required" onchange="get_section_subject_by_class(this.value, '','');">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="subject_id" id="add_subject_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                         
                                        </select>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12" name="day" id="day" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="teacher_id"  id="add_teacher_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_routine">
                            <div class="x_content"> 
                               ...
                               <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="class_id" id="edit_class_id" required="required" onchange="get_section_subject_by_class(this.value, '','');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($classes as $obj ){ ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="subject_id" id="edit_subject_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                         
                                        </select>
                                        <div class="help-block"><?php echo form_error('subject_id'); ?></div>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="teacher_id"  id="edit_teacher_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($teachers as $obj ){ ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Routine Info</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="routineForm" action="<?= site_url('academic/routine/add'); ?>" method="POST">
                    <div class="form-group">
                        <label for="subject">Subject</label>
                        <select class="form-control select2_mamun" id="subject_id_modal" name="subject_id" required>
                            <option value="">--Select--</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="teacher">Teacher </label>
                        <select class="form-control select2_mamun" id="teacher" name="teacher_id" required>
                            <option value="">--Select--</option> 
                    ...
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo $this->lang->line('start_time'); ?> <span class="required">*</span>
                            ...
                            <input  class="form-control col-md-7 col-xs-12"  name="start_time"  id="modal_start_time" value="" placeholder="<?php echo $this->lang->line('start_time'); ?>" required="required" type="text" autocomplete="off">
                    ...
                    <div class="item form-group">
                        ...
                        <input  class="form-control col-md-7 col-xs-12"  name="end_time"  id="modal_end_time" value="<?php echo isset($post['end_time']) ?  $post['end_time'] : ''; ?>" placeholder="<?php echo $this->lang->line('end_time'); ?>" required="required" type="text" autocomplete="off">
                    ...
                    <input type="hidden" id="school_id" name="school_id" value="<?php echo $filter_school_id;?>">
                    <input type="hidden" id="class_id" name="class_id" value="<?php echo $filter_class_id;?>">
                    <input type="hidden" id="modal_section_id" name="section_id" value="">
                    <input type="hidden" id="modal_day_id" name="day" value="">
...
$(document).ready(function() {
    ...
    <?php if(isset($filter_class_id)){ ?>
        get_subject_by_class_index('<?php echo $filter_class_id; ?>','<?php echo $filter_school_id;?>');
    <?php } ?>

    function get_subject_by_class_index(class_id, school_id){        
        ...
        $.ajax({       
            ...
            success: function(response){                                                   
               if(response)
               {
                  $('#subject_id_modal').html(response);
               }
            }
        });                  
   ...
   $(".routine_modal").click(function () {
         ...
         $(".modal-body #modal_section_id").val( sectionId );
         $(".modal-body #modal_day_id").val( dayId );
         
    });

    $('#saveRoutine').click(function(event) {
        
        const formData = $('#routineForm').serialize(); // Serialize form data
        $.ajax({
            url: '<?= site_url("academic/routine/add"); ?>',
            method: 'POST',
            data: formData,
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    $('.routine_modal').modal('hide'); // Close modal
