        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($insert_id) {
                    ...
                    $data_x['text_msg_id'] = $insert_id;
                    $data_x = $data;
                    $data_x['month'] = $_POST['month'];
                    $data_x['receiver_id'] = $_POST['receiver_id'];
                    $data_x['role_id'] = $_POST['role_id'];
    ...
    * ********************************************************** */
    private function _send_sms($data) {
        ...
        else
        {
            ...
            $this->db->where('I.paid_status', 'unpaid');
            $this->db->like('I.month', $month);
            $this->db->where('S.user_id', $data['receiver_id']);
            $users = $this->db->get()->result(); 
        }
