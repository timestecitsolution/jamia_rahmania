<div class="row ">
    ...
    <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
     ...
     <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
        <a href="<?php echo site_url('student/birthday/add'); ?>">
            ...
            <div style="    background-color: #7D3C98;border: 4px solid #7D3C98; border-radius: 5px; color:#fff; "> 
                <span class="count_top"><i class="fa fa-birthday-cake" aria-hidden="true"></i> <?php echo $this->lang->line('birthday'); ?></span>
            </div>
                <div class="count"><?php echo $birthday_today ? $birthday_today :0; ?></div>
            </div>
        </a>
    </div>
    </div>
