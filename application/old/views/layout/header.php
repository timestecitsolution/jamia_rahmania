        ...
        <nav>
            <div class="col-md-1">
                <div class="nav toggle">
                    <a id="menu_toggle"><img src="<?php echo IMG_URL; ?>/menu.png"></a>
                </div>
            </div>
            <div class="col-md-7 ">
                        ...
                        <?php if ($this->session->userdata('role_id') == SUPER_ADMIN) { ?>                
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="item form-group">        
                                    <select  class="select2_mamun form-control col-md-7 col-xs-12" name="search_school_id" id="search_school_id" required="required">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="row">
                        <?php if ($this->session->userdata('role_id') == SUPER_ADMIN) { ?>                
                            <div class="col-md-5 col-sm-5 col-xs-12">
                                <div class="item form-group">        
                                    <select  class="select2_mamun form-control col-md-7 col-xs-12" name="ay_school_id" id="ay_school_id" required="required" onchange="get_academic_year_by_school(this.value, '');">
                                        <option value="">--<?php echo $this->lang->line('select_school'); ?>--</option>
                                        <?php foreach ($this->schools as $obj) { ?>
                                            <option value="<?php echo $obj->id; ?>" ><?php echo $obj->school_name; ?></option>
                                        <?php } ?>
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-12">
                            <div class="item form-group"> 
                                <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="ay_academic_year_id"  id="ay_academic_year_id" required="required">
