        ...
        <div class="x_panel">
            ...
            <div class="x_content"> 
                ...
                <div class="row">  
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 <?php if(!isset($final_result_type) && $final_result_type != 1){ echo 'display'; } ?>">
                            ...
                            <?php  $result = get_exam_final_result($school_id, $obj->id, $academic_year_id,  $class_id, $section_id ); ?>
                                ...
                                <tr>
                                    ...
                                    <?php                                         
                                       ...
                                       $remark = $mark->remark ;
                                       $subject = $mark->total_subject > 0 ? $mark->total_subject : '';
                                       ...
                                       $obtain_mark = $mark->total_obtain_mark;
                                       $obtain_total_mark = $mark->total_obtain_mark;
                                       
                                       $grade_point = $mark->avg_grade_point > 0 ? $mark->avg_grade_point : '';
                                       $total_grade_point = $mark->avg_grade_point > 0 ? $mark->avg_grade_point : '';
                                       
                                                                                                         
                                    ?>                                    
                                    <td width="15%"> <?php echo $ex->title; ?></td>
                                    <td> 
                                        <?php echo $subject; ?>
                                    ...
                                    <td>
                                        <input class="form-control col-md-7 col-xs-12 " type="text" name="total_obtain_mark[<?php echo $obj->id; ?>]" value="<?php echo $obtain_total_mark; ?>" style="width: 60px;"  autocomplete="off" readonly/>
                                    </td>                                                                   
                                    <td>
                                        <input class="form-control col-md-7 col-xs-12 " type="text" name="avg_grade_point[<?php echo $obj->id; ?>]" value="<?php echo $total_grade_point; ?>" style="width: 60px;"  autocomplete="off" readonly/>
                                    </td>  
                                    <td>
                                        <select class="form-control col-md-7 col-xs-12" name="grade_id[<?php echo $obj->id; ?>]"  required="required" disabled>                                
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                        ...
                                        <input type="hidden" name="grade_id[<?php echo $obj->id; ?>]" value="<?php echo $mark->grade_id; ?>">
                                    </td>                                    
                ...
                <div class="form-group">
                    <div class="col-md-6 col-md-offset-5">
                        <?php  if (isset($students) && !empty($students)) { ?>
                         ...
                         <a href="<?php echo site_url('exam/finalresult/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
