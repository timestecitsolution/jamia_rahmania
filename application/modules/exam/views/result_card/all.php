                                    ...
                                    <div>                       
                                        ...
                                        <div style="display:flex;justify-content:center;align-items:center;gap:20px;text-align:center;">
                                            ...
                                            <div class="school_info">
                                                <span style="font-size:36px;color:#0aaafa!important;"><?php echo convert_bangla_to_arabic($school->school_name); ?></span>
                                        ...
                                        <table id="datatable-responsive" class="table table-striped_ table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            <tbody id="fn_mark"> 
                                                ...
                                                <?php foreach($exams as $ex){ ?>
                                                    ...
                                                    <?php
                                                    $exam_subjects = get_subject_list($school_id, $academic_year_id, $ex->id, $class_id, $section_id, $student->id);
                                                    $count = 1;
                                                    ...
                                                    <?php foreach ($exam_subjects as $obj) { ?>
                                                        ...
                                                        <?php $exam = get_exam_result($school_id, $ex->id, $student->id, $academic_year_id, $class_id, $section_id); ?>
                                        ...
                                        <table id="datatable-responsive" class="table table-striped_ table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            ?>
                                                ...
                                                <?php foreach ($exams as $ex) { ?>
                                                    ...
                                                    <?php $mark = get_exam_wise_markt($school_id, $academic_year_id, $ex->id, $class_id, $section_id, $student->id ); ?>
                                                    ...
                                                    <?php $exam_lh = get_lowet_height_result($school_id, $academic_year_id, $ex->id, $class_id, $section_id, $student->id); ?>
                                    ...
                                    <table class="table table-striped_ table-bordered dt-responsive nowrap" style="display:none;" cellspacing="0" width="100%">
                                        <thead>
                                         ...
                                         <tbody>
                                            ...
                                            <?php $class_position = get_student_position($school_id, $academic_year_id, $class_id, $student->id); ?>    
                                            <?php $section_position = get_student_position($school_id, $academic_year_id, $class_id,$student->id, $section_id); ?> 
                                             ...
                                             <tr>
                                                 ...
                                                 <td><?php echo isset($final_result->total_obtain_mark)? getNumberPosition($all_mark_array, $final_result->total_obtain_mark) : ''; ?></td> 
