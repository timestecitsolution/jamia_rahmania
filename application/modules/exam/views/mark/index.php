                    ...
                    <div class="x_content"> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 col-sm-10 col-xs-12">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    <div class="item form-group"> 
                                        <div><?php echo $this->lang->line('written'); ?></div>
                                        <input type="number" id="written_mark_num" value="" class="form-control form-mark col-md-7 col-xs-12 "  />
                                    </div>
                                </div>
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    <div class="item form-group"> 
                                        <div><?php echo $this->lang->line('tutorial'); ?></div>
                                        <input type="number" id="tutorial_mark_num" value="" class="form-control form-mark col-md-7 col-xs-12 "  />
                                    </div>
                                </div>
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    <div class="item form-group"> 
                                        <div><?php echo $this->lang->line('practical'); ?></div>
                                        <input type="number" id="practical_mark_num" value="" class="form-control form-mark col-md-7 col-xs-12 "  />
                                    </div>
                                </div>
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    <div class="item form-group"> 
                                        <div><?php echo $this->lang->line('viva'); ?></div>
                                        <input type="number" id="viva_mark_num" value="" class="form-control form-mark col-md-7 col-xs-12 "  />
                                    </div>
                                </div>
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                <div class="form-group"><br/>
                                    <input id="mark_input_x" type="button" class="btn btn-success" value="Apply">
                                </div>
                            </div>
                        </div>
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2" style="display: none;"><?php echo $this->lang->line('letter_grade'); ?></th>                                            
                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            <?php  $attendance = get_exam_attendance($school_id, $obj->student_id, $academic_year_id, $exam_id, $class_id, $section_id, $subject_id); ?>
                                <tr>
                                    ...
                                    <td>
                                        <input type="number"  id="tutorial_mark_<?php echo $obj->student_id; ?>" itemid="<?php echo $obj->student_id; ?>"  value="<?php if(!empty($mark) && $mark->tutorial_mark > 0){ echo $mark->tutorial_mark; }else{ echo '';} ?>"  name="tutorial_mark[<?php echo $obj->student_id; ?>]" class="form-control form-mark col-md-7 col-xs-12 fn_mark_total fn_tutorial_mark"   autocomplete="off"/>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="number"  id="practical_mark_<?php echo $obj->student_id; ?>" itemid="<?php echo $obj->student_id; ?>"  value="<?php if(!empty($mark) && $mark->practical_mark > 0){ echo $mark->practical_mark; }else{ echo '';} ?>"  name="practical_mark[<?php echo $obj->student_id; ?>]" class="form-control col-md-7 form-mark col-xs-12 fn_mark_total fn_practical_mark"   autocomplete="off"/>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="number"  id="viva_mark_<?php echo $obj->student_id; ?>" itemid="<?php echo $obj->student_id; ?>"  value="<?php if(!empty($mark) && $mark->viva_mark > 0){ echo $mark->viva_mark; }else{ echo '';} ?>"  name="viva_mark[<?php echo $obj->student_id; ?>]" class="form-control form-mark col-md-7 col-xs-12 fn_mark_total fn_viva_mark"  autocomplete="off"/>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="number"  id="exam_total_mark_<?php echo $obj->student_id; ?>" value="<?php if(!empty($mark) && $mark->exam_total_mark > 0){ echo $mark->exam_total_mark; }else{ echo '';} ?>"  name="exam_total_mark[<?php echo $obj->student_id; ?>]" class="form-control form-mark col-md-7 col-xs-12 exam_total_mark"  autocomplete="off" />
                                    </td>
                                    <td>
                                        
                                            <input type="number"  id="obtain_total_mark_<?php echo $obj->student_id; ?>" value="<?php if(!empty($mark) && $mark->obtain_total_mark > 0 ){ echo $mark->obtain_total_mark; }else{ echo ''; } ?>"  name="obtain_total_mark[<?php echo $obj->student_id; ?>]" class="form-control form-mark col-md-7 col-xs-12"  autocomplete="off" readonly/>
                                        
                                    </td>                                    
                                    <td style="display: none;">
                                        
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12" id="grade_id_<?php echo $obj->student_id; ?>" name="grade_id[<?php echo $obj->student_id; ?>]"  required="required">                                
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                             <?php foreach ($grades as $grade) { ?>
                                            <option value="<?php echo $grade->id; ?>" <?php if(isset($mark) && $mark->grade_id == $grade->id || $mark->grade_id == 0){ echo 'selected="selected"';}  ?>><?php echo $grade->name; ?> [<?php echo $grade->point; ?>]</option>
                                            <?php } ?>
                                        </select>
                                    </td>
                                    <td>
