                        ...
                        <div class="row">
                            <div class="col-sm-6 col-xs-6  col-sm-offset-3  col-xs-offset-3 layout-box">
                                <p>
                                    ...
                                    <div>
                                        <?php if($school->logo){ ?>
                                            <img height="80px" src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $school->logo; ?>" alt="" /> 
                                         <?php }else if($school->frontend_logo){ ?>
                                            <img height="80px" src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $school->frontend_logo; ?>" alt="" /> 
                                         <?php }else{ ?>                                                        
                                            <img height="80px" src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $this->global_setting->brand_logo; ?>" alt=""  />
                                         <?php } ?>
                                    </div>
                           ...
                           <thead>
                            ...
                            <tbody id="fn_mark">   
                                ...
                                if (isset($subjects[$key]) && !empty($subjects[$key])) {
                                    ?>
                                    <?php foreach ($subjects[$key] as $obj) { 
