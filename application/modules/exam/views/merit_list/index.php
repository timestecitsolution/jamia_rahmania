                ...
                <div class="row">  
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="select2_mamun form-control col-md-7 col-xs-12" name="academic_year_id" required="required" id="academic_year_id">
                     ...
                     <tbody>   
                            ...
                            $count = 1; if(isset($examresult) && !empty($examresult)){ ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo convert_to_bangla_digits($obj->total_subject); ?></td>
                                    <td><?php echo convert_to_bangla_digits($obj->total_mark); ?></td>
                                    <td><?php echo convert_to_bangla_digits($obj->total_obtain_mark); ?></td>
                                    <td><?php echo $obj->total_mark > 0 && $obj->total_obtain_mark > 0 ? convert_to_bangla_digits(number_format($obj->total_obtain_mark/$obj->total_mark*100, 2)) : 0; ?>%</td> 
                                    <td><?php echo $obj->avg_grade_point; ?></td>
                                    <td><?php echo $obj->grade; ?></td>
                                    <td><?php echo $this->lang->line($obj->result_status); ?></td>
                                    
                                    <td><?php echo getNumberPosition($all_mark_array, $obj->total_obtain_mark); ?></td> 
