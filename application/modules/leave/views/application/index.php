                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <li class="li-class-list">
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                  
                                <select  class="select2_mamun form-control col-md-7 col-xs-12 auto-width" name="school_id_filter" id="school_id_filter" onchange="get_application_by_school_filter(this.value)">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('leave/application/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">  
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="type_id"  id="add_type_id" required="required" >
                               ...
                               <?php echo form_open_multipart(site_url('leave/application/edit/'.$application->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <?php $this->load->view('layout/school_list_edit_form'); ?>  
                                    ...
                                    <div class="item form-group">  
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="type_id"><?php echo $this->lang->line('leave_type'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="type_id"  id="edit_type_id" required="required" >
                                                <option itemid="" value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                         
                                            </select>
                                            <div class="help-block"><?php echo form_error('type_id'); ?></div>
                                        </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div><a target="_blank" href="<?php echo UPLOAD_PATH; ?>/leave/<?php echo $application->attachment; ?>" class="btn btn-success"><i class="fa fa-download"></i> <?php echo $this->lang->line('download'); ?></a><br/><br/></div>
                                            <?php } ?>
                                            <div class="btn btn-default btn-file">
                                                <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                <input  class="form-control col-md-7 col-xs-12"  name="attachment"  id="attachment" type="file">
