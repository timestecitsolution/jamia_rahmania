...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bell-o"></i><small> <?php echo $this->lang->line('manage_approved_application'); ?></small></h3>
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <li class="li-class-list">
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                  
                                <select  class="select2_mamun form-control col-md-7 col-xs-12 auto-width" name="school_id_filter" id="school_id_filter" onchange="get_approved_leave_by_school_filter(this.value)">
                                    <option value="<?php echo site_url('leave/approve/index'); ?>">--<?php echo $this->lang->line('select_school'); ?>--</option> 
                                    <?php foreach($schools as $obj ){ ?>
                                        <option value="<?php echo site_url('leave/approve/index/'.$obj->id); ?>" <?php if(isset($filter_school_id) && $filter_school_id == $obj->id){ echo 'selected="selected"';} ?> > <?php echo $obj->school_name; ?></option>
                                    <?php } ?>   
                                </select>
                            <?php } ?>
                        </li> 
                    ...
                    <div class="tab-content">
                                    ...
                                    <?php $count = 1; if(isset($applications) && !empty($applications)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>                                                       
                                                ...
                                                <?php } ?> 
                                                 <?php if(has_permission(DELETE, 'leave', 'approve')){ ?>    
                                                    <a href="<?php echo site_url('leave/approve/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>   
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <?php if(isset($edit)){ ?>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('leave/approve/update/'.$application->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <?php $this->load->view('layout/school_list_edit_form'); ?>  
                                    ...
                                    <div class="item form-group"> 
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="select2_mamun form-control col-md-12 col-xs-12" name="role_id"  id="role_id" required="required" onchange="get_user_by_role(this.value, '');">
                                    ...
                                    <div class="item form-group display"> 
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="class_id"  id="class_id"  onchange="get_user('', this.value,'');">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                                <?php foreach($classes as $obj ){ ?>
                                                    <option value="<?php echo $obj->id; ?>" <?php echo $application->class_id == $obj->id ? 'selected="selected"' : ''; ?>><?php echo $obj->name; ?></option>
                                                <?php } ?> 
                                            </select>
                                    ...
                                    <div class="item form-group">  
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="type_id"  id="type_id" required="required" onchange="get_type(this.value)">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <a  href="<?php echo site_url('leave/approve/index/'.$application->school_id); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
...
<script type="text/javascript">
    ...
    function get_application_modal(application_id){
        ...
        $.ajax({       
          type   : "POST",
          url    : "<?php echo site_url('leave/approve/get_single_application'); ?>",
...
<link href="<?php echo VENDOR_URL; ?>datepicker/datepicker.css" rel="stylesheet">
 ...
 <script type="text/javascript">
    ...
    function get_user_by_role(role_id, user_id){     
       ...
       var type_id = '';       
       <?php if(isset($application)){ ?> 
            get_user(role_id, '<?php echo $application->class_id; ?>', user_id);
   ...
   $(document).ready(function() {
    ...
    $("#edit").validate();   
       ...
       /* Menu Filter Start */   
    function get_approved_leave_by_school_filter(url){          
       if(url){
