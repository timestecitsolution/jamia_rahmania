                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php } ?>                
                            ...
                            <?php }else{  ?>
                                ...
                                <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_lecture_by_class(this.value);">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php 
                                                    ...
                                                    if(!empty($vimeo)){  echo '<img src="' .$vimeo[0]['thumbnail_small'].'" width="130"/>';   }
                                                ?>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('teacher/lecture/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="subject_id"  id="add_subject_id" required="required" onchange="get_teacher_by_subject();">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                      
                                        </select>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="lecture_type"  id="lecture_type" required="required" onchange="get_video_lecture_type(this.value, 'add');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('teacher/lecture/edit/'.$lecture->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="lecture_type"><?php echo $this->lang->line('lecture_type'); ?> <span class="required">*</span> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="lecture_type"  id="lecture_type" required="required" onchange="get_video_lecture_type(this.value, 'edit');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                            <?php $types = get_video_types(); ?>
                                            <?php foreach($types as $key=>$value){ ?>
