                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <li class="li-class-list">
                           <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                                <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_product_by_school(this.value);">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('inventory/product/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="warehouse_id"  id="add_warehouse_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_product">
                            <div class="x_content">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="warehouse_id"><?php echo $this->lang->line('warehouse'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="warehouse_id"  id="edit_warehouse_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php if(isset($warehouses) && !empty($warehouses)){ ?>
                                                <?php foreach($warehouses as $obj){ ?>
