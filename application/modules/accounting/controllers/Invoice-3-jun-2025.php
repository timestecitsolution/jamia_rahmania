...
class Invoice extends MY_Controller {
    ...
    * ********************************************************** */
    private function _prepare_invoice_validation() {
        ...
        $this->form_validation->set_rules('amount_recieved_from_zakat', $this->lang->line('amount_recieved_from_zakat'), 'trim|callback_check_zakat_limit'); 
    ...
    private function _get_posted_invoice_data() {
        ...
        // save invoice data
         ...
         if(($invoice_id) && ($inv_data['zakat_eligibility'] != null) && (($zakat_fund_prev_amount->zakat_fund != 0) || ($zakat_fund_prev_amount->zakat_fund != null))){
        ...
        foreach ($this->input->post('income_head_id') as $key=>$value){
            ...
            if(($invoice_id) && ($inv_detail['income_head_id'] == '77')){
                $updated_boarding_fund = $boarding_fund_prev_amount->boarding_fund + $data['net_amount'];
    ...
    * ********************************************************** */
    ...
    //             $str .= '<option value="' . $key_array_m . '" ' . ($key_array_m == 0 ? 'selected' : '') . '>' . $array_m_value . ' </option>';
    //         }
    //     }
