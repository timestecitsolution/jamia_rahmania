...
class Expenditure extends MY_Controller {
       ...
       check_permission(EDIT);
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                $add_amount = $expenditure->amount - $data['amount'];
    ...
    public function validate_expenditure_amount($amount)
    {
        ...
        if ($fund < $amount) {
            $this->form_validation->set_message('validate_expenditure_amount', 'আপনার ফান্ডে পর্যাপ্ত পরিমাণ টাকা নেই।');
            return false;
        }
    ...
    private function _prepare_expenditure_validation() {
        ...
        $this->form_validation->set_rules('amount', $this->lang->line('amount'), 'trim|required|numeric|callback_validate_expenditure_amount');   
