                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                             <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_discount_by_school(this.value);">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('accounting/discount/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12" name="discount_type" id="discount_type" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                            <option value="flat" <?php echo isset($post['discount_type']) && $post['discount_type'] == 'flat' ?  'selected="selected"' : ''; ?>><?php echo $this->lang->line('flat_amount'); ?></option>                                           
                                            <option value="percentage" <?php echo isset($post['discount_type']) && $post['discount_type'] == 'percentage' ?  'selected="selected"' : ''; ?>><?php echo $this->lang->line('percentage_amount'); ?></option>                                           
                                        </select>
