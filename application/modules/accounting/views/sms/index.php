<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-envelope-o"></i><small> <?php echo $this->lang->line('manage_due_fee_sms'); ?></small></h3>
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                             <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_sms_by_school(this.value);">
                                     <option value="<?php echo site_url('accounting/duefeesms/index'); ?>">--<?php echo $this->lang->line('select_school'); ?>--</option> 
                               ...
                               <?php echo form_open_multipart(site_url('accounting/duefeesms/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <?php
                                        $array_months = months();
                                        $array_m[0] = 'Please Select';
                                        foreach ($array_months as $key => $hostel) {
                                                $array_m[$key] = $hostel;
                                        }
                                        echo form_dropdown("month", $array_m, set_value("month"), "id='user_by_month' class='js-example-basic-multiple col-md-7 col-xs-12 form-control select2' placeholder='Month'");
                                        ?>
                                ...
                                <div class="item form-group" style="display: none;"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="class_id"  id="class_id" required="required" onchange="get_user('', this.value,'');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
   ...
   $('#user_by_month').on('change', function(){
        var school_id = $('#add_school_id').val();
        var month = $('#user_by_month').val();
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('ajax/get_user_by_month'); ?>",
            data   : {school_id:school_id, month : month},               
            async  : false,
            success: function(response){                                                   
               if(response)
               {
