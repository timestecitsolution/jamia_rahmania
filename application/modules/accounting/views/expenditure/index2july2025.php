                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                             <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_exp_by_school(this.value);">
                               ...
                               <?php echo form_open_multipart(site_url('accounting/expenditure/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="expenditure_head_id"  id="add_expenditure_head_id" required="required" >
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="income_head_id"  id="add_income_head_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="expenditure_via"  id="add_expenditure_via" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                             
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_expenditure">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('accounting/expenditure/edit/'.$expenditure->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <?php
                                    $selected_income_head_id = '';
                                    if (isset($post['income_head_id'])) {
                                        $selected_income_head_id = $post['income_head_id'];
                                    } elseif (isset($expenditure->income_head_id)) {
                                        $selected_income_head_id = $expenditure->income_head_id;
                                    }
                                ?>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="income_head_id"><?php echo $this->lang->line('income_head'); ?> <span class="required">*</span>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="income_head_id"  id="edit_income_head_id" required="required" disabled>
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php if(isset($income_heads) && !empty($income_heads)){ ?>
                                                <?php foreach($income_heads as $obj ){ ?>
                                                <option value="<?php echo $obj->id; ?>"  <?php echo isset($post['income_head_id']) && $post['income_head_id'] == $obj->id ?  'selected="selected"' : ''; ?>><?php echo $obj->title; ?></option>
                                        ...
                                        <input type="hidden" name="income_head_id" value="<?php echo $selected_income_head_id; ?>">
                                        <div class="help-block"><?php echo form_error('income_head_id'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="expenditure_via"  id="edit_expenditure_via" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php if(isset($payments) && !empty($payments)){ ?>
                                                <?php foreach($payments as $key=>$value ){ ?>
  ...
  $('#edit_date').datepicker();
    ...
    $('.fn_school_id').on('change', function(){
        ...
        <?php if(isset($edit) && !empty($edit)){ ?>
            ...
            income_head_id =  '<?php echo $expenditure->income_head_id; ?>';
       ...
       $.ajax({       
        ...
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('accounting/expenditure/get_income_head_by_school'); ?>",
