                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                             <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_feetype_by_school(this.value);">
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('collection_type'); ?></th>
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($feetypes) && !empty($feetypes)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $obj->collection_type; ?></td>
                                            ...
                                            <td> 
                                                ...
                                                <?php  } ?>
                                                <?php if(has_permission(EDIT, 'accounting', 'feetype') && ($obj->id != '77')){ ?>
                                                ...
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'accounting', 'feetype') && ($obj->id != '77')){ ?>
                               ...
                               <?php echo form_open(site_url('accounting/feetype/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12" name="head_type" id="fee_type" onchange="show_class_amount(this.value, false);">
                                            ...
                                            <option value="sale" <?php if(isset($post['head_type']) && $post['head_type'] == 'sale'){ echo 'selected="selected"'; } ?>><?php echo $this->lang->line('product_sale'); ?></option>  
                                ...
                                <div class="fn_add_collection_block display">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="collection_type"><?php echo $this->lang->line('collection_type'); ?> </label>
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <label>
                                            <input type="radio" name="collection_type" value="Monthly" checked> Monthly
                                        </label>
                                       
                                        <label>
                                            <input type="radio" name="collection_type" value="Single Collection"> Single Collection
                                        </label>
                                        
                                        
                                        <div class="help-block"><?php echo form_error('collection_type'); ?></div>
                                    </div>
                                </div>
                                <br>
                               ...
                               <?php echo form_open(site_url('accounting/feetype/edit/'.$feetype->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <?php $this->load->view('layout/school_list_edit_form'); ?>
                                 ...
                                 <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="head_type"><?php echo $this->lang->line('fee_type'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12" name="head_type" id="fee_type" onchange="show_class_amount(this.value, true);">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                            ...
                                            <option value="sale" <?php if(isset($feetype->head_type) && $feetype->head_type == 'sale'){ echo 'selected="selected"'; } ?>><?php echo $this->lang->line('product_sale'); ?></option>  
                                ...
                                <?php 
                                    $selected_collection_type = isset($feetype->collection_type) ? $feetype->collection_type : ''; 
                                ?>

                                <div class="fn_edit_collection_block <?php if(isset($feetype) && $feetype->head_type != 'fee'){ echo 'display'; } ?>">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="collection_type">
                                        <?php echo $this->lang->line('collection_type'); ?> 
                                    </label>
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <label>
                                            <input type="radio" name="collection_type" value="Monthly" 
                                                <?php echo ($selected_collection_type == 'Monthly') ? 'checked' : ''; ?>> Monthly
                                        </label>

                                        <label>
                                            <input type="radio" name="collection_type" value="Single Collection" 
                                                <?php echo ($selected_collection_type == 'Single Collection') ? 'checked' : ''; ?>> Single Collection
                                        </label>
 ...
 <script type="text/javascript">
    ...
    function show_class_amount(fee_type, is_edit){
        ...
        if(fee_type == 'fee' && is_edit == true){
           ...
           $('.fn_edit_collection_block').show(); 
           
        }else if(fee_type == 'fee' && is_edit == false){
            
           $('.fn_amount_head').show();             
           $('.fn_add_classes_block').show(); 
           $('.fn_add_collection_block').show(); 
           
        }else if(fee_type == 'hostel' || fee_type == 'transport' && fee_type != ''){
             
             $('.fn_amount_head').hide(); 
             $('.fn_add_classes_block').hide(); 
             $('.fn_edit_classes_block').hide(); 
             $('.fn_add_collection_block').hide(); 
             $('.fn_edit_collection_block').hide(); 
             $('.fn_instruction').show(); 
             
        }else if(fee_type == 'sale' && fee_type != ''){
