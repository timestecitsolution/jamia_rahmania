                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($incomeheads) && !empty($incomeheads)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>                                                
                                                <?php if(has_permission(EDIT, 'accounting', 'incomehead') && (($obj->id != '75') && ($obj->id != '76') && ($obj->id != '67'))){ ?>
                                                ...
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'accounting', 'incomehead') && (($obj->id != '75') && ($obj->id != '76') && ($obj->id != '67'))){ ?>
