<div class="row no-print">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-calculator"></i><small> <?php echo $this->lang->line('manage_receipt'); ?></small></h3>
            ...
            <div class="x_content no-print"> 
                <?php echo form_open_multipart(site_url('accounting/invoice/receipt'), array('name' => 'receipt', 'id' => 'receipt', 'class' => 'form-horizontal form-label-left'), ''); ?>
                <div class="row">
                                       ...
                                       <?php $count = 1; if(isset($receipts) && !empty($receipts)){ ?>
                                           ...
                                           <tr>
                                               <td><?php echo $count++; ?></td>
                                                ...
                                                <?php } ?>
                                               <td><?php echo $obj->custom_invoice_id.$obj->invoice_id; ?></td>
                                               <td><?php echo $obj->student_name; ?></td>
                                               <td><?php echo $obj->class_name; ?></td>
                                               <td><?php echo get_paid_status($obj->paid_status); ?></td>
                                               <td><?php echo $obj->amount; ?></td>
                                               <td>
                                                  <a  onclick="get_receipt_modal(<?php echo $obj->school_id; ?>,<?php echo $obj->txn_id; ?>,<?php echo $obj->class_id; ?>,<?php echo $obj->section_id; ?>,<?php echo $obj->student_id; ?>);"  data-toggle="modal" data-target=".bs-receipt-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a>
                                               </td>
                                           </tr>
                                           <?php } ?>
                                       <?php } ?>
...
<script type="text/javascript">
    ...
    function get_receipt_modal(school_id, txn_id, class_id, section_id, student_id){
         
        $('.fn_news_data').html('<p style="padding: 20px;"><p style="padding: 20px;text-align:center;"><img src="<?php echo IMG_URL; ?>loading.gif" /></p>');
        $.ajax({       
          type   : "POST",
          url    : "<?php echo site_url('accounting/invoice/get_single_receipt'); ?>",
          data   : {school_id:school_id, txn_id:txn_id, class_id:class_id, section_id:section_id, student_id:student_id},  
