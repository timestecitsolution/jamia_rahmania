...
<script type="text/javascript"> 
    ...
    $('#discount_val').on('keyup', function(){
        ...
        // var x = amount - discount_val;
        // if(parseFloat(discount_val) > parseFloat(amount) )
        // {
    ...
    function due_amount(){
        ...
        var partial_amount = $('#partial_payment_amount').val();
        var due_amount = (total_payable - parseFloat(partial_amount));
