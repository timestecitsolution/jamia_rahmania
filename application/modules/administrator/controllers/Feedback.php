...
class Feedback extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        $this->data['guardian'] = $this->feedback->get_guardian_list();
        $this->data['list'] = TRUE;
    ...
    * ********************************************************** */
     private function _get_posted_feedback_data() {
        ...
        $data['guardian_id'] = $data['guardian'];
        unset($data['guardian']);
        $data['status'] = 1;
        ...
        $guardian_info = $this->feedback->get_single('guardians', array('id' => $data['guardian_id']));
        $this->feedback->get_single('guardian_feedbacks', $data);
        $data['school_id'] = $guardian_info->school_id;
        return $data;
    }
