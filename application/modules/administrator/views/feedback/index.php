                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php } ?>   -->
                            ...
                            <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('administrator/feedback/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                             <?php }else{ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="#tab_add_feedback"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                             <?php } ?>
                    </ul>
                    <br/>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('administrator/feedback/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                <div class="item form-group">
                                     <label class="control-label col-md-3 col-sm-3 col-xs-12" for="guardian"><?php echo $this->lang->line('guardian'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="select2_mamun form-control col-md-7 col-xs-12" name="guardian" id="guardian">
                                            <option value="">--<?php echo $this->lang->line('guardian'); ?>--</option>
                                            <?php foreach($guardian as $guardians){ ?>
                                                <option value="<?php echo $guardians->id; ?>"><?php echo $guardians->name; ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="select2_mamun form-control col-md-7 col-xs-12" name="guardian" id="guardian">
                                            <option value="">--<?php echo $this->lang->line('guardian'); ?>--</option>
                                            <?php foreach($guardian as $guardians){ ?>
                                                <option value="<?php echo $guardians->id; ?>" <?php if($feedback->guardian_id == $guardians->id){echo 'selected="selected"';}?>><?php echo $guardians->name; ?></option>
                                            <?php } ?>
                                        </select>
                                        <div class="help-block"><?php echo form_error('guardian'); ?></div>
