<div class="" data-example-id="togglable-tabs">
    <ul  class="nav nav-tabs bordered">
        <li  class="active"><a href="#tab_pop_bulksmsbd_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> Bulk SMS BD</a> </li> 

        <li  class=""><a href="#tab_pop_twilio_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('twilio'); ?></a> </li>                          
        ...
        <li  class="<?php echo isset($bulkpk) || isset($cluster) || isset($alpha) || isset($bdbulk) || isset($mimsms) ? 'active':''; ?> dropdown">
            ...
            <ul class="dropdown-menu">
                <li  class=""><a href="#tab_pop_bulkpk_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('bulk_pk'); ?> </a> </li>                          
                ...
                <li  class=""><a href="#tab_pop_bulk360_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('bulk_360'); ?> </a> </li>                          
                <li  class=""><a href="#tab_pop_smsto_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('sms_to'); ?> </a> </li>
            </ul>
    ...
    <br/>
     ...
     <div class="tab-content"> 
         <div  class="tab-pane fade in active" id="tab_pop_bulksmsbd_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
                    <th width="50%">URL</th>
                    <td><?php echo $sms_setting->bulksmsbd_url; ?></td> 
                </tr>                    
                <tr>
                    <th>API Key</th>
                    <td><?php echo $sms_setting->bulksmsbd_api_key; ?></td>
                </tr>                
                <tr>
                    <th>Sender ID</th>
                    <td><?php echo $sms_setting->bulksmsbd_senderid; ?></td>
                </tr>                
                <tr>
                    <th><?php echo $this->lang->line('is_active'); ?></th>
                    <td><?php echo $sms_setting->bulksmsbd_status ? $this->lang->line('yes'): $this->lang->line('no'); ?></td>
                </tr>               
        ...
        <div  class="tab-pane fade in" id="tab_pop_twilio_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
        ...
        <div  class="tab-pane fade in" id="tab_pop_bulk360_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
                    <th><?php echo $this->lang->line('username'); ?></th>
                    <td><?php echo $sms_setting->bulk360_username; ?></td> 
                </tr>
                <tr>
                    <th><?php echo $this->lang->line('password'); ?></th>
                    <td><?php echo $sms_setting->bulk360_password; ?></td> 
                </tr>  
                <tr>
                    <th><?php echo $this->lang->line('from_number'); ?></th>
                    <td><?php echo $sms_setting->bulk360_from_no; ?></td> 
                </tr>                 
                <tr>
                    <th><?php echo $this->lang->line('is_active'); ?></th>
                    <td><?php echo $sms_setting->bulk360_status ? $this->lang->line('yes'): $this->lang->line('no'); ?></td>
                </tr> 
            </tbody>
            </table>
        </div>
         
        <div  class="tab-pane fade in" id="tab_pop_smsto_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
                    <th><?php echo $this->lang->line('api_key'); ?></th>
                    <td><?php echo $sms_setting->smsto_api_key; ?></td> 
                </tr>
                <tr>
                    <th><?php echo $this->lang->line('sender_id'); ?></th>
                    <td><?php echo $sms_setting->smsto_sender_id; ?></td> 
                </tr>  
                <tr>
                    <th><?php echo $this->lang->line('is_active'); ?></th>
                    <td><?php echo $sms_setting->smsto_status ? $this->lang->line('yes'): $this->lang->line('no'); ?></td>
                </tr> 
            </tbody>
            </table>
        </div> 
