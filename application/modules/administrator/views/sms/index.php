                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($sms_settings) && !empty($sms_settings)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $obj->bulksmsbd_status ? $this->lang->line('yes') : $this->lang->line('no') ; ?></td>
                                ...
                                <div class="row">
                                    <div class="col-xs-3">
                                        <ul class="nav nav-tabs tabs-left">
                                            <li  class="active"><a href="#tab_bulksmsbd_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> Bulk SMS BD</a> </li>  
                                            <li  class=""><a href="#tab_twilio_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('twilio'); ?></a> </li>                          
                                            ...
                                            <li  class=""><a href="#tab_bulk360_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('bulk_360'); ?></a> </li>                          
                                            <li  class=""><a href="#tab_smsto_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('sms_to'); ?></a> </li>
                                        </ul>
                                      </div> 
                                    <div class="col-xs-9">
                                        <div class="tab-content">

                                            <div class="tab-pane fade in active" id="tab_bulksmsbd_setting">                           
                                                                                               
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bulksmsbd_url">URL <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input  class="form-control col-md-7 col-xs-12"  name="bulksmsbd_url" value="<?php echo isset($sms_setting) ? $sms_setting->bulksmsbd_url : ''; ?>"  placeholder="<?php echo $this->lang->line('auth_token'); ?>" required="required" type="text" autocomplete="off">
                                                        <div class="help-block"><?php echo form_error('bulksmsbd_url'); ?></div>
                                                    </div>
                                                </div>                                               
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bulksmsbd_api_key">API Key <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input  class="form-control col-md-7 col-xs-12"  name="bulksmsbd_api_key" value="<?php echo isset($sms_setting) ? $sms_setting->bulksmsbd_api_key : ''; ?>"  placeholder="<?php echo $this->lang->line('from_number'); ?>" required="required" type="text" autocomplete="off">
                                                        <div class="help-block"><?php echo form_error('bulksmsbd_api_key'); ?></div>
                                                    </div>
                                                </div> 
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bulksmsbd_senderid">Sender ID <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input  class="form-control col-md-7 col-xs-12"  name="bulksmsbd_senderid" value="<?php echo isset($sms_setting) ? $sms_setting->bulksmsbd_senderid : ''; ?>"  placeholder="<?php echo $this->lang->line('account_sid'); ?>" required="required" type="text" autocomplete="off">
                                                        <div class="help-block"><?php echo form_error('bulksmsbd_senderid'); ?></div>
                                                    </div>
                                                </div>
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bulksmsbd_status"><?php echo $this->lang->line('is_active'); ?> <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="bulksmsbd_status" required="required">
                                                            <option value="0" <?php if(isset($sms_setting) && $sms_setting->bulksmsbd_status == '0'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('no'); ?></option>
                                                            <option value="1" <?php if(isset($sms_setting) && $sms_setting->bulksmsbd_status == '1'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('yes'); ?></option>
                                                        </select>
                                                        <div class="help-block"><?php echo form_error('bulksmsbd_status'); ?></div>
                                                    </div>
                                                </div>                          
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bulksmsbdurl">&nbsp;</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <a href="https://bulksmsbd.com/" target="_blank"><img src="<?php echo IMG_URL; ?>bulksmsbd.png" alt="" /></a> 
                                                    </div>
                                                </div>
                                            </div> 


                                            <div class="tab-pane fade in" id="tab_twilio_setting">                           
                                                <div class="item form-group">
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="twilio_status" required="required">
                                                ...
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="twiliourl">&nbsp;</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="tab-pane fade in " id="tab_clickatell_setting">
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="clickatell_status" required="required">
                                                ...
                                                <div class="item form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="clickatellurl">&nbsp;</label>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="tab-pane fade in " id="tab_bulk_setting">                          
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="bulk_status">
                                                ...
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bulksmsurl">&nbsp;</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="tab-pane fade in " id="tab_msg91_setting">                        
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="msg91_status" required="required">
                                                ...
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="msg91url">&nbsp;</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="tab-pane fade in " id="tab_plivo_setting">                            
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="plivo_status" required="required">
                                                ...
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="plivourl">&nbsp;</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="tab-pane fade in " id="tab_textlocal_setting">                         
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="textlocal_status" required="required">
                                                ...
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textlocalurl">&nbsp;</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="tab-pane fade in " id="tab_smscountry_setting">                            
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="smscountry_status" required="required">
                                               ...
                                               <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="smscountryurl">&nbsp;</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="tab-pane fade in " id="tab_betasms_setting">                            
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="betasms_status" required="required">
                                               ...
                                               <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="betasmsurl">&nbsp;</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="tab-pane fade in " id="tab_bulkpk_setting">                            
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="bulk_pk_status" required="required">
                                            ...
                                            <div class="tab-pane fade in " id="tab_cluster_setting">                            
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="cluster_status" required="required">
                                               ...
                                               <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="smsclusterurl">&nbsp;</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="tab-pane fade in " id="tab_alpha_setting">                            
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="alpha_type" required="required">
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="alpha_status" required="required">
                                               ...
                                               <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="alphaurl">&nbsp;</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="tab-pane fade in " id="tab_bdbulk_setting">                            
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="bdbulk_type" required="required">
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="bdbulk_status" required="required">
                                               ...
                                               <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bdbulksmsurl">&nbsp;</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="tab-pane fade in " id="tab_mimsms_setting">                            
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="mim_type" required="required">
                                               ...
                                               <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="mimsmsurl">&nbsp;</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="tab-pane fade in " id="tab_bulk360_setting">                            
                                                
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bulk360_username"><?php echo $this->lang->line('username'); ?> <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input  class="form-control col-md-7 col-xs-12"  name="bulk360_username" value="<?php echo isset($sms_setting) ? $sms_setting->bulk360_username : ''; ?>"  placeholder="<?php echo $this->lang->line('username'); ?>" required="required" type="text" autocomplete="off">
                                                        <div class="help-block"><?php echo form_error('bulk360_username'); ?></div>
                                                    </div>
                                                </div>    
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bulk360_password"><?php echo $this->lang->line('password'); ?> <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input  class="form-control col-md-7 col-xs-12"  name="bulk360_password" value="<?php echo isset($sms_setting) ? $sms_setting->bulk360_password : ''; ?>"  placeholder="<?php echo $this->lang->line('password'); ?>" required="required" type="text" autocomplete="off">
                                                        <div class="help-block"><?php echo form_error('bulk360_password'); ?></div>
                                                    </div>
                                                </div> 
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bulk360_from_no"><?php echo $this->lang->line('from_number'); ?> <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input  class="form-control col-md-7 col-xs-12"  name="bulk360_from_no" value="<?php echo isset($sms_setting) ? $sms_setting->bulk360_from_no : ''; ?>"  placeholder="<?php echo $this->lang->line('from_number'); ?>" required="required" type="text" autocomplete="off">
                                                        <div class="help-block"><?php echo form_error('bulk360_from_no'); ?></div>
                                                    </div>
                                                </div>                                                
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bulk360_status"><?php echo $this->lang->line('is_active'); ?> <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="bulk360_status" required="required">
                                                            <option value="0" <?php if(isset($sms_setting) && $sms_setting->bulk360_status == '0'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('no'); ?></option>
                                                            <option value="1" <?php if(isset($sms_setting) && $sms_setting->bulk360_status == '1'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('yes'); ?></option>
                                                        </select>
                                                        <div class="help-block"><?php echo form_error('bulk360_status'); ?></div>
                                                    </div>
                                                </div>                          
                                               <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bulk360url">&nbsp;</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <a href="https://www.bulk360.com/" target="_blank"><img src="<?php echo IMG_URL; ?>bulk360-setting.png" alt="" /></a> 
                                                         <div class="instructions">Malaysian SMS Gateway</div>
                                                    </div>
                                                </div>                                
                                            </div>
                                            
                                            <div class="tab-pane fade in " id="tab_smsto_setting">                            
                                                
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="smsto_api_key"><?php echo $this->lang->line('api_key'); ?> <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input  class="form-control col-md-7 col-xs-12"  name="smsto_api_key" value="<?php echo isset($sms_setting) ? $sms_setting->smsto_api_key : ''; ?>"  placeholder="<?php echo $this->lang->line('api_key'); ?>" required="required" type="text" autocomplete="off">
                                                        <div class="help-block"><?php echo form_error('smsto_api_key'); ?></div>
                                                    </div>
                                                </div>    
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="smsto_sender_id"><?php echo $this->lang->line('sender_id'); ?> <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input  class="form-control col-md-7 col-xs-12"  name="smsto_sender_id" value="<?php echo isset($sms_setting) ? $sms_setting->smsto_sender_id : ''; ?>"  placeholder="<?php echo $this->lang->line('sender_id'); ?>" required="required" type="text" autocomplete="off">
                                                        <div class="help-block"><?php echo form_error('smsto_sender_id'); ?></div>
                                                    </div>
                                                </div> 
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="smsto_status"><?php echo $this->lang->line('is_active'); ?> <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="smsto_status" required="required">
                                                            <option value="0" <?php if(isset($sms_setting) && $sms_setting->smsto_status == '0'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('no'); ?></option>
                                                            <option value="1" <?php if(isset($sms_setting) && $sms_setting->smsto_status == '1'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('yes'); ?></option>
                                                        </select>
                                                        <div class="help-block"><?php echo form_error('smsto_status'); ?></div>
                                                    </div>
                                                </div>                          
                                               <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="smstourl">&nbsp;</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <a href="https://sms.to/" target="_blank"><img src="<?php echo IMG_URL; ?>smsto-setting.png" alt="" /></a> 
                                                         <div class="instructions">Multinational SMS Gateway</div>
                                                    </div>
                                                </div>                                
                                            </div>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('administrator/sms/edit/'.$sms_setting->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">
                                    <div class="col-xs-3">
                                        <ul class="nav nav-tabs tabs-left">
                                            <li  class="active"><a href="#tab_edit_bulksmsbd_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> Bulk SMS BD</a> </li>  

                                            <li  class=""><a href="#tab_edit_twilio_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('twilio'); ?></a> </li>                          
                                            ...
                                            <li  class=""><a href="#tab_edit_bulk360_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('bulk_360'); ?></a> </li>                          
                                            <li  class=""><a href="#tab_edit_smsto_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('sms_to'); ?></a> </li>
                                        </ul>
                                      </div> 
                                    <div class="col-xs-9">
                                        <div class="tab-content">

                                            <div class="tab-pane fade in active" id="tab_edit_bulksmsbd_setting">                           
                                            ...
                                            <div class="tab-pane fade in " id="tab_edit_twilio_setting">                           
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="twilio_account_sid"><?php echo $this->lang->line('account_sid'); ?> <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input  class="form-control col-md-7 col-xs-12"  name="twilio_account_sid" value="<?php echo isset($sms_setting) ? $sms_setting->twilio_account_sid : ''; ?>"  placeholder="<?php echo $this->lang->line('account_sid'); ?>" required="required" type="text" autocomplete="off">
                                            ...
                                            <div class="tab-pane fade in " id="tab_edit_alpha_setting">    
                                               ...
                                               <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="alphauel">&nbsp;</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <a href="https://alpha.net.bd/" target="_blank"><img src="<?php echo IMG_URL; ?>alpha-sms.png" alt="" /></a> 
                                                        <div class="instructions">Bangladeshi SMS Gateway</div>
                                                    </div>
                                            ...
                                            <div class="tab-pane fade in " id="tab_edit_mimsms_setting">                            
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="mim_status" required="required">
                                            ...
                                            <div class="tab-pane fade in " id="tab_edit_bulk360_setting">                            
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bulk360_username"><?php echo $this->lang->line('username'); ?> <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input  class="form-control col-md-7 col-xs-12"  name="bulk360_username" value="<?php echo isset($sms_setting) ? $sms_setting->bulk360_username : ''; ?>"  placeholder="<?php echo $this->lang->line('username'); ?>" required="required" type="text" autocomplete="off">
                                               ...
                                               <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="sms360url">&nbsp;</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <a href="https://sms.360.my/developers/v1.4" target="_blank"><img src="<?php echo IMG_URL; ?>bulk360-setting.png" alt="" /></a> 
                                                        <div class="instructions">Malaysian SMS Gateway</div>
                                                    </div>
                                                </div>                                
                                            </div> 
                                            
                                            <div class="tab-pane fade in " id="tab_edit_smsto_setting">                            
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="smsto_api_key"><?php echo $this->lang->line('api_key'); ?> <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input  class="form-control col-md-7 col-xs-12"  name="smsto_api_key" value="<?php echo isset($sms_setting) ? $sms_setting->smsto_api_key : ''; ?>"  placeholder="<?php echo $this->lang->line('api_key'); ?>" required="required" type="text" autocomplete="off">
                                                ...
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="smsto_sender_id"><?php echo $this->lang->line('sender_id'); ?> <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input  class="form-control col-md-7 col-xs-12"  name="smsto_sender_id" value="<?php echo isset($sms_setting) ? $sms_setting->smsto_sender_id : ''; ?>"  placeholder="<?php echo $this->lang->line('password'); ?>" required="required" type="text" autocomplete="off">
                                                        <div class="help-block"><?php echo form_error('smsto_sender_id'); ?></div>
                                                    </div>
                                                </div>                                
