                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">                 
                        ...
                        <li class="li-class-list">
                            <select  class="select2_mamun form-control col-md-7 col-xs-12" id="filter_class_id" name="class_id"  style="width:auto;" onchange="get_permission_setting_by_role(this.value)">
