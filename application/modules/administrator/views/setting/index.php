                            ...
                            <div class="x_content"> 
                                ...
                                <input type="hidden" value="<?php echo isset($setting) ? $setting->id : ''; ?>" name="id" />
                                 ...
                                 <div class="item form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">                                      
                                        <input  class="form-control col-md-7 col-xs-12"  name="brand_name"  id="brand_name" required="required" value="<?php echo isset($setting) ?  $setting->brand_name : ''; ?>" placeholder="<?php echo $this->lang->line('brand_name'); ?> " type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('brand_name'); ?></div> 
                                    </div>
                                </div>
                                
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="brand_title"><?php echo $this->lang->line('brand_title'); ?> <span class="required">*</span></label>
                                   <div class="col-md-6 col-sm-6 col-xs-12">                                      
                                        <input  class="form-control col-md-7 col-xs-12"  name="brand_title"  id="brand_title" required="required" value="<?php echo isset($setting) ?  $setting->brand_title : ''; ?>" placeholder="<?php echo $this->lang->line('brand_title'); ?> " type="text" autocomplete="off">
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="language"  required="required">
                                ...
                                <div class="item form-group">
                                   <label  class="control-label col-md-3 col-sm-3 col-xs-12" for="enable_rtl"><?php echo $this->lang->line('enable_rtl'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="enable_rtl" required="required">
                                ...
                                <div class="item form-group">
                                    <label  class="control-label col-md-3 col-sm-3 col-xs-12" for="auto_sms">Auto SMS<span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="auto_sms" required="required">
                                                <option value="0" <?php if(isset($setting) && $setting->auto_sms == 0){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('no'); ?></option>
                                                <option value="1" <?php if(isset($setting) && $setting->auto_sms == 1){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('yes'); ?></option>
                                        </select>
                                        <div class="help-block"><?php echo form_error('auto_sms'); ?></div> 
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="enable_frontend" required="required">
                                ...
                                <div class="item form-group">
                                    <label   class="control-label col-md-3 col-sm-3 col-xs-12"  for="theme_name"><?php echo $this->lang->line('theme'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="theme_name" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                ...
                                <div class="item form-group">
                                    <label  class="control-label col-md-3 col-sm-3 col-xs-12"  for="default_time_zone"><?php echo $this->lang->line('default_time_zone'); ?> <span class="required">*</span></label>
                                        ...
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="time_zone" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                ...
                                <div class="item form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="date_format" required="required">
                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="text-info"><?php echo $this->lang->line('dimension'); ?>:- Max-W: 20px, Max-H: 20px</div>     
