                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="payment_to"  id="payment_to" required="required" onchange="get_user_list(this.value);">
                                    ...
                                    <div class="row">                                        
                                        ...
                                        <div class="col-md-2 col-sm-2 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <input class="form-control col-md-7 col-xs-12 fn_add_claculate" name="paid_amount" id="add_paid_amount" value="0.00" placeholder="Paid Amount" type="number" autocomplete="off" >
                                        ...
                                        <div class="col-md-2 col-sm-2 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <input class="form-control col-md-7 col-xs-12 fn_add_claculate" name="total_paid" id="add_total_paid" value="0.00" placeholder="Total Paid" type="number" autocomplete="off" readonly="readonly">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2 col-sm-2 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <input class="form-control col-md-7 col-xs-12 fn_total_due" name="total_due" id="add_total_due" value="<?php echo $payment->salary_type == 'monthly' ? $payment->net_salary : ''; ?>" placeholder="Total Due" type="number" autocomplete="off" readonly="readonly">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select  class="select2_mamun form-control col-md-7 col-xs-12" name="expenditure_head_id"  id="expenditure_head_id" required="required" >
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('payroll/payment/edit/'.$edit_payment->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="payment_method"><?php echo $this->lang->line('payment_method'); ?> <span class="required">*</span></label>
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12" name="payment_method"  id="edit_payment_method" required="required" onchange="check_payment_method(this.value);">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php $payments = get_payment_methods(); ?>
                                            <?php foreach($payments as $key=>$value ){ ?>                                           
                                                <?php if(in_array($key, array('cash', 'cheque'))){ ?>
                                    ...
                                    <div class="col-md-2 col-sm-2 col-xs-12">
                                            <div class="item form-group">
                                                <label for="paid_amount">Paid Amount </label>
                                                <input class="form-control col-md-7 col-xs-12 fn_edit_claculate" name="paid_amount" id="edit_paid_amount" value="0.00" placeholder="Paid Amount" type="number" autocomplete="off" >
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="expenditure_head_id"><?php echo $this->lang->line('expenditure_head'); ?> <span class="required">*</span> </label>
                                                <select  class="select2_mamun form-control col-md-7 col-xs-12" name="expenditure_head_id"  id="edit_expenditure_head_id" required="required" >
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                                    <?php foreach($exp_heads as $obj ){ ?>                                           
 ...
 <script type="text/javascript">
    ...
    $('.fn_add_claculate').on('keyup', function(){
        ...
        if(type === 'monthly'){
            ...
            var paid_amount = $('#add_paid_amount').val() ? parseFloat($('#add_paid_amount').val()) : 0;
           ...
           $('#add_total_allowance').val(house_rent+transport+medical+bonus+ot_total_amount);       
            ...
            $('#add_total_paid').val(paid_amount);
            $('#add_total_due').val((basic_salary+total_allowance)-(total_deduction+paid_amount));
