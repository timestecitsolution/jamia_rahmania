        ...
        <div class="x_panel">
            ...
            <?php $this->load->view('quick_report'); ?>   
             ...
             <div class="x_content filter-box no-print"> 
                ...
                <?php echo form_open_multipart(site_url('report/donation'), array('name' => 'donation', 'id' => 'donation', 'class' => 'form-horizontal form-label-left'), ''); ?>
                <div class="row">   
                   ...
                   <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="item form-group"> 
                        <?php echo $this->lang->line('donar_type'); ?>
                        <select class="select2_mamun form-control col-md-7 col-xs-12" name="doner_type">
                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                            <?php $types = get_donar_types(); ?>
                            <?php foreach($types as $key => $value){ ?>
                                <option value="<?php echo $key; ?>" 
                                    <?php echo (isset($doner_type) && $doner_type == $key) ? 'selected="selected"' : ''; ?>>
                                    <?php echo $value; ?>
                                </option>
                            <?php } ?>
                        </select>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="item form-group"> 
                        <?php echo $this->lang->line('donation_category'); ?>
                        <select class="select2_mamun form-control col-md-7 col-xs-12" name="donation_category">
                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                            <?php $category = get_donation_category(); ?>
                            <?php foreach($category as $key => $value){ ?>
                                <option value="<?php echo $key; ?>" 
                                    <?php echo (isset($donation_category) && $donation_category == $key) ? 'selected="selected"' : ''; ?>>
                                    <?php echo $value; ?>
                                </option>
                            <?php } ?>
                        </select>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_donar_list" >
                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    if (isset($donation_lists) && !empty($donation_lists)) { 
                                        foreach ($donation_lists as $obj) { 
                                    ?>                                       
                                        <tr>
                                            <td><?php echo $count++; ?></td>  
                                            <td><?php echo $obj->doner_name; ?></td>
                                            <td><?php echo $obj->doner_type; ?></td>
                                            <td><?php echo $obj->donation_category; ?></td>
                                            <td><?php echo date($this->global_setting->date_format, strtotime($obj->donation_date)); ?></td>
                                            <td class="text-right"><?php echo number_format($obj->amount, 2); ?></td>
                                        </tr>
                                    <?php 
