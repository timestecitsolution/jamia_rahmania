<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('fee_collection_report'); ?></small></h3>                
                ...
                <div class="row">   
                   ...
                   <div class="col-md-3 col-sm-3 col-xs-12">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="select2_mamun form-control col-md-7 col-xs-12" name="class_id" id="class_id"  onchange="get_student_by_class(this.value, '');">
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            <div>Fee Type</div>
                            <select  class="select2_mamun form-control col-md-7 col-xs-12" name="income_head" id="income_head">
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                <?php foreach ($income_heads as $obj) { ?>
                                <option value="<?php echo $obj['id']; ?>" <?php if(isset($income_head) && $income_head == $obj['id']){ echo 'selected="selected"';} ?>><?php echo $obj['title']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                   ...
                   <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="select2_mamun form-control col-md-7 col-xs-12" name="student_id" id="student_id" >                                
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                            </select>
                        </div>
                    </div> 
                           ...
                           <div class="col-sm-6  col-xs-6 layout-box">
                               <div>
                                 ...
                                 <?php } ?>
                                   ...
                                   <h3 class="head-title ptint-title" style="width: 100%;"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('fee_collection_report'); ?></small></h3>                
                                   <div class="clearfix">&nbsp;</div>
                               </div>
                           </div>
                            <div class="col-sm-3  col-xs-3">&nbsp;</div>
                                ...
                                <tbody>   
                                    ...
                                    $count = 1; if(isset($feecollection) && !empty($feecollection)){ ?>
                                        <?php foreach($feecollection as $obj){
                                            ...
                                            $month_value = $obj->month;
                                            $month_value = json_decode($month_value);
                                            $text_month = "";

                                            if (is_array($month_value)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a  onclick="get_invoice_modal(<?php echo $obj->inv_id; ?>);"  data-toggle="modal" data-target=".bs-invoice-modal-lg"  class="btn btn-success btn-xs"> <?php echo $obj->custom_invoice_id;  ?> </a></td>
                                            <td><?php echo $text_month; ?></td>
                                            <td><?php echo $obj->fee_type; ?></td>
                                        ...
                                        <?php } ?>
                                        <tr>
                                            <td colspan="10"><strong><?php echo $this->lang->line('total_amount'); ?></strong></td>
                                            <td class="green"><strong><?php echo number_format($amount,2); ?></strong></td>                                           
                                        </tr>
                                    <?php }else{ ?>
                                        <tr><td colspan="9" class="text-center"><?php echo $this->lang->line('no_data_found'); ?></td></tr>
                                    <?php } ?>
                                </tbody>
                            </table>
                            </div>
