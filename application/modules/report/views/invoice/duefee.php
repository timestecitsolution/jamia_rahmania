                           ...
                           <div class="col-sm-6  col-xs-6 layout-box">
                               <div>
                                 ...
                                 <?php } ?>
                                   ...
                                   <h3 class="head-title ptint-title" style="width: 100%;"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('due_fee_report'); ?></small></h3>                
                                   <div class="clearfix">&nbsp;</div>
                               </div>
                           </div>
                            <div class="col-sm-3  col-xs-3">&nbsp;</div>
                                ...
                                <tbody>   
                                    ...
                                    $count = 1; if(isset($sbalance) && !empty($sbalance)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a  onclick="get_invoice_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-invoice-modal-lg"  class="btn btn-success btn-xs"> <?php echo $obj->custom_invoice_id;  ?> </a></td>
                                        ...
                                        <?php } ?>
                                        <tr>
                                            <td colspan="8"><strong><?php echo $this->lang->line('total_balance'); ?></strong></td>
