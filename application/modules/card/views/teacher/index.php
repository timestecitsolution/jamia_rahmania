                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="teacher_id"  id="teacher_id">
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">                    
                    <ul  class="nav nav-tabs bordered no-print">                 
                        <li  class="active"><a href="#tab_teacher_list" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa fa-users"></i> <?php echo $this->lang->line('list'); ?></a></li>                          
                    </ul>
                    <br/>
                                            ...
                                            <div class="card-block">
                                                ...
                                                <div class="card-main">
                                                    ...
                                                    <div class="card-info">
                                                        ...
                                                        <p><span class="card-title"><?php echo $this->lang->line('department'); ?></span><span class="card-value">: <?php echo $obj->department; ?></span></p>
