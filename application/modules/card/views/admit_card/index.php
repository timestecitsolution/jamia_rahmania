<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-barcode"></i><small> <?php echo $this->lang->line('manage_admit_card_setting'); ?></small></h3>
                ...
                <div class="" data-example-id="togglable-tabs">                    
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(has_permission(ADD, 'card', 'admitsetting')){ ?>
                            <?php if(isset($edit)){ ?>
                        <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('card/admitsetting/add'); ?>" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                            <?php }else{ ?>
                    ...
                    <div class="tab-content">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if(has_permission(EDIT, 'card', 'admitsetting')){ ?>
                                                    <a href="<?php echo site_url('card/admitsetting/edit/'.$obj->id); ?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'card', 'admitsetting')){ ?>
                                                    <a href="<?php echo site_url('card/admitsetting/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('card/admitsetting/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 ">
                                        <div class="input-group fn_colorpicker">
                                            <input  class="form-control col-md-7 col-xs-12 " readonly="readonly"  name="border_color"  id="border_color" value="<?php echo isset($post['border_color']) ?  $post['border_color'] : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('border_color'); ?>" type="text" autocomplete="off">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 ">
                                        <div class="input-group fn_colorpicker">
                                            <input  class="form-control col-md-7 col-xs-12 " readonly="readonly"  name="top_bg"  id="top_bg" value="<?php echo isset($post['top_bg']) ?  $post['top_bg'] : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('top_background'); ?> " type="text" autocomplete="off">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="school_name"  id="school_name" value="<?php echo isset($post['school_name']) ?  $post['school_name'] : ''; ?>" placeholder="<?php echo $this->lang->line('card_school_name'); ?>" type="text" autocomplete="off">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="school_name_font_size"  id="school_name_font_size" max="28" value="<?php echo isset($post['school_name_font_size']) ?  $post['school_name_font_size'] : ''; ?>" placeholder="<?php echo $this->lang->line('school_name_font_size'); ?>" type="number" autocomplete="off">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group fn_colorpicker">
                                            <input  class="form-control col-md-7 col-xs-12"  name="school_name_color"  id="school_name_color" readonly="readonly" value="<?php echo isset($post['school_name_color']) ?  $post['school_name_color'] : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('school_name_color'); ?>" type="text" autocomplete="off">
                                         <span class="input-group-addon"><i></i></span>
                                        </div>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="school_address"  id="school_address" value="<?php echo isset($post['school_address']) ?  $post['school_address'] : ''; ?>" placeholder="<?php echo $this->lang->line('school_address'); ?>" type="text" autocomplete="off">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group fn_colorpicker">
                                        <input  class="form-control col-md-7 col-xs-12"  name="school_address_color"  id="school_address_color" readonly="readonly"  value="<?php echo isset($post['school_address_color']) ?  $post['school_address_color'] : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('school_address_color'); ?>" type="text" autocomplete="off">
                                        <span class="input-group-addon"><i></i></span>
                                        </div>
                                ...
                                <div class="form-group"> 
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="admit_font_size"><?php echo $this->lang->line('admit_title_font_size'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="admit_font_size"  id="admit_font_size" max="20" value="<?php echo isset($post['admit_font_size']) ?  $post['admit_font_size'] : ''; ?>" placeholder="<?php echo $this->lang->line('admit_title_font_size'); ?> " type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('admit_font_size'); ?></div>
                                    </div>
                                </div>
                                
                                <div class="form-group"> 
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="admit_color"><?php echo $this->lang->line('admit_title_color'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group fn_colorpicker">
                                            <input  class="form-control col-md-7 col-xs-12"  name="admit_color"  id="admit_color" readonly="readonly" value="<?php echo isset($post['admit_color']) ?  $post['admit_color'] : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('admit_title_color'); ?> " type="text" autocomplete="off">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                ...
                                <div class="form-group"> 
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="admit_bg"><?php echo $this->lang->line('admit_title_background'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group fn_colorpicker">
                                            <input  class="form-control col-md-7 col-xs-12"  name="admit_bg"  id="admit_bg" readonly="readonly" value="<?php echo isset($post['admit_bg']) ?  $post['admit_bg'] : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('admit_title_background'); ?> " type="text" autocomplete="off">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title_font_size"  id="title_font_size" max="12" value="<?php echo isset($post['title_font_size']) ?  $post['title_font_size'] : ''; ?>" placeholder="<?php echo $this->lang->line('title_font_size'); ?> " type="number" autocomplete="off">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group fn_colorpicker">
                                            <input  class="form-control col-md-7 col-xs-12"  name="title_color"  id="title_color" readonly="readonly" value="<?php echo isset($post['title_color']) ?  $post['title_color'] : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('title_color'); ?> " type="text" autocomplete="off">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="value_font_size"  id="value_font_size" max="13" value="<?php echo isset($post['value_font_size']) ?  $post['value_font_size'] : ''; ?>" placeholder="<?php echo $this->lang->line('value_font_size'); ?> " type="number" autocomplete="off">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group fn_colorpicker">
                                            <input  class="form-control col-md-7 col-xs-12"  name="value_color"  id="value_color" readonly="readonly" value="<?php echo isset($post['value_color']) ?  $post['value_color'] : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('value_color'); ?> " type="text" autocomplete="off">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                ...
                                <div class="form-group"> 
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="exam_font_size"><?php echo $this->lang->line('exam_title_font_size'); ?>  </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="exam_font_size"  id="exam_font_size" value="<?php echo isset($post['exam_font_size']) ?  $post['exam_font_size'] : ''; ?>"  placeholder="<?php echo $this->lang->line('exam_title_font_size'); ?> " type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('exam_font_size'); ?></div>
                                    </div>
                                </div>                                
                                                                    
                                <div class="form-group"> 
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="exam_color"><?php echo $this->lang->line('exam_title_color'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12 ">
                                        <div class="input-group fn_colorpicker">
                                            <input  class="form-control col-md-7 col-xs-12 " readonly="readonly"  name="exam_color"  id="exam_color" value="<?php echo isset($post['exam_color']) ?  $post['exam_color'] : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('exam_title_color'); ?> " type="text" autocomplete="off">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                ...
                                <div class="form-group"> 
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="subject_font_size"><?php echo $this->lang->line('subject_font_size'); ?>  </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="subject_font_size"  id="subject_font_size"  value="<?php echo isset($post['subject_font_size']) ?  $post['subject_font_size'] : ''; ?>" placeholder="<?php echo $this->lang->line('subject_font_size'); ?> " type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('subject_font_size'); ?></div>
                                    </div>
                                </div>                                
                                                                    
                                <div class="form-group"> 
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="subject_color"><?php echo $this->lang->line('subject_color'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12 ">
                                        <div class="input-group fn_colorpicker">
                                            <input  class="form-control col-md-7 col-xs-12 " readonly="readonly"  name="subject_color"  id="subject_color" value="<?php echo isset($post['subject_color']) ?  $post['subject_color'] : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('subject_color'); ?> " type="text" autocomplete="off">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="bottom_text"  id="bottom_text" value="<?php echo isset($post['bottom_text']) ?  $post['bottom_text'] : ''; ?>" required="required" placeholder="<?php echo $this->lang->line('bottom_signature'); ?> " type="text" autocomplete="off">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 ">
                                        <div class="input-group fn_colorpicker">
                                            <input  class="form-control col-md-7 col-xs-12 " readonly="readonly"  name="bottom_bg"  id="bottom_bg" value="<?php echo isset($post['bottom_bg']) ?  $post['bottom_bg'] : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('signature_background'); ?> " type="text" autocomplete="off">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group fn_colorpicker">
                                        <input  class="form-control col-md-7 col-xs-12"  name="bottom_text_color"  id="bottom_text_color" readonly="readonly"  value="<?php echo isset($post['bottom_text_color']) ?  $post['bottom_text_color'] : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('signature_color'); ?>" type="text" autocomplete="off">
                                        <span class="input-group-addon"><i></i></span>
                                        </div>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="bottom_text_align"  id="bottom_text_align">
                                            <option value="">--<?php echo $this->lang->line('select'); ?> --</option> 
                                            <?php foreach($aligns as $key=>$value ){ ?>
                                                <option value="<?php echo $key; ?>" <?php if(isset($post) && $post['bottom_text_align'] == $key ){ echo 'selected="selected"';} ?>><?php echo $value; ?></option>
                                            <?php } ?>                                            
                                        </select>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($edit)){ echo 'active'; }?>" id="tab_edit_setting">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('card/admitsetting/edit/'.$setting->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group"> 
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="admit_font_size"><?php echo $this->lang->line('admit_title_font_size'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="admit_font_size"  id="admit_font_size" max="20" value="<?php echo isset($setting->admit_font_size) ?  $setting->admit_font_size : ''; ?>" placeholder="<?php echo $this->lang->line('admit_title_font_size'); ?> " type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('admit_font_size'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group fn_colorpicker">
                                            <input  class="form-control col-md-7 col-xs-12"  name="admit_color"  id="admit_color" readonly="readonly" value="<?php echo isset($setting->admit_color) ?  $setting->admit_color : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('admit_title_color'); ?> " type="text" autocomplete="off">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                        <div class="help-block"><?php echo form_error('admit_color'); ?></div>
                                    </div>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group fn_colorpicker">
                                            <input  class="form-control col-md-7 col-xs-12"  name="admit_bg"  id="admit_bg" readonly="readonly" value="<?php echo isset($setting->admit_bg) ?  $setting->admit_bg : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('admit_title_background'); ?> " type="text" autocomplete="off">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                        <div class="help-block"><?php echo form_error('admit_bg'); ?></div>
                                    </div>
                                ...
                                <div class="form-group"> 
                                 ...
                                 <div class="form-group"> 
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="exam_font_size"><?php echo $this->lang->line('exam_title_font_size'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="exam_font_size"  id="exam_font_size" max="13" value="<?php echo isset($setting->exam_font_size) ?  $setting->exam_font_size : ''; ?>" placeholder="<?php echo $this->lang->line('exam_title_font_size'); ?>" type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('exam_font_size'); ?></div>
                                    </div>
                                </div>
                                 <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group fn_colorpicker">
                                            <input  class="form-control col-md-7 col-xs-12"  name="exam_color"  id="exam_color" readonly="readonly" value="<?php echo isset($setting->exam_color) ?  $setting->exam_color : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('exam_title_color'); ?>" type="text" autocomplete="off">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                        <div class="help-block"><?php echo form_error('exam_color'); ?></div>
                                    </div>
                                ...
                                <div class="form-group"> 
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="subject_font_size"><?php echo $this->lang->line('subject_font_size'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="subject_font_size"  id="subject_font_size" max="13" value="<?php echo isset($setting->subject_font_size) ?  $setting->subject_font_size : ''; ?>" placeholder="<?php echo $this->lang->line('subject_font_size'); ?> " type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('subject_font_size'); ?></div>
                                    </div>
                                </div>
                                 <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group fn_colorpicker">
                                            <input  class="form-control col-md-7 col-xs-12"  name="subject_color"  id="subject_color" readonly="readonly" value="<?php echo isset($setting->subject_color) ?  $setting->subject_color : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('subject_color'); ?> " type="text" autocomplete="off">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                        <div class="help-block"><?php echo form_error('subject_color'); ?></div>
                                    </div>
