            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">                    
                    <ul  class="nav nav-tabs bordered">
                        <li class="active"><a href="#tab_setting_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-gears"></i> <?php echo $this->lang->line('admit_card_setting'); ?></a> </li>
                    </ul>
                    <br/>
                    ...
                    <div class="tab-content">                    
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('card/schooladmitsetting/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="school_address"  id="school_address" value="<?php echo isset($post['school_address']) ?  $post['school_address'] : 'e01ab5'; ?>" placeholder="<?php echo $this->lang->line('school_address'); ?>" type="text" autocomplete="off">
                        ...
                        <div  class="tab-pane fade in <?php if(!empty($setting)){ echo 'active'; }?>" id="tab_edit_setting">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('card/schooladmitsetting/edit/'.$setting->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group"> 
                                 ...
                                 <div class="form-group"> 
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="exam_font_size"><?php echo $this->lang->line('exam_title_font_size'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="exam_font_size"  id="exam_font_size" max="15" value="<?php echo isset($setting->exam_font_size) ?  $setting->exam_font_size : ''; ?>" placeholder="<?php echo $this->lang->line('exam_title_font_size'); ?> " type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('exam_font_size'); ?></div>
                                    </div>
                                </div>
