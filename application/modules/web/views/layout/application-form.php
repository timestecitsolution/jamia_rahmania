...
<!-- Mirrored from live.themewild.com/eduka/application-form.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 05:54:30 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
    ...
    <!-- css -->
    <link rel="stylesheet" href="<?php echo CSS_URL; ?>assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo CSS_URL; ?>assets/css/all-fontawesome.min.css">
    <link rel="stylesheet" href="<?php echo CSS_URL; ?>assets/css/animate.min.css">
    <link rel="stylesheet" href="<?php echo CSS_URL; ?>assets/css/magnific-popup.min.css">
    <link rel="stylesheet" href="<?php echo CSS_URL; ?>assets/css/owl.carousel.min.css">
...
<body>
                    ...
                    <div class="header-top-right">
                        <div class="header-top-contact">
                            <ul>
                                ...
                                <li>
                                    <a href="https://live.themewild.com/cdn-cgi/l/email-protection#adc4c3cbc2edc8d5ccc0ddc1c883cec2c0"><i class="far fa-envelopes"></i> <span class="__cf_email__" data-cfemail="7910171f16391c01181409151c571a1614">[email&#160;protected]</span></a>
                                </li>
                                <li>
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container position-relative">
                    <a class="navbar-brand" href="index-2.html">
                        <img src="<?php echo CSS_URL; ?>assets/img/logo/logo.png" alt="logo">
                    </a>
                                                ...
                                                <div class="col-12 col-sm-4 col-md-3">
                                                    ...
                                                    <div class="menu-about">
                                                        <a href="#" class="menu-about-logo"><img
                                                                src="<?php echo CSS_URL; ?>assets/img/logo/logo.png" alt=""></a>
                                ...
                                <ul class="dropdown-menu fade-down">
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item" href="facility-single.html">Facility Single</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown-submenu">
    ...
    <footer class="footer-area">
        <div class="footer-shape">
            <img src="<?php echo CSS_URL; ?>assets/img/shape/03.png" alt="">
        </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="footer-widget-box about-us">
                            <a href="#" class="footer-logo">
                                <img src="<?php echo CSS_URL; ?>assets/img/logo/logo.png" alt="">
                            </a>
                            <p class="mb-3">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#e78e898188a7829f868a978b82c984888a"><i
