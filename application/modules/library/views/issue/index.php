                    ...
                    <ul  class="nav nav-tabs bordered">
                       ...
                       <li class="li-class-list">
                           <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                                <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_book_list_by_school(this.value);">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(EDIT, 'library', 'issue')){ ?>
                                                    ...
                                                    <?php } ?>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'library', 'issue')){ ?>
                                                    <a href="<?php echo site_url('library/issue/delete/'.$obj->issue_id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>        
                                            </td>
                                        </tr>
                                        <?php } ?>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('library/issue/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12 fn_get_book" name="book_id" id="book_id" required="required">
                               ...
                               <div class="item form-group">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12" name="library_member_id" id="library_member_id" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
