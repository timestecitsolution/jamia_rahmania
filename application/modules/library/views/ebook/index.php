                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <li class="li-class-list">
                            ...
                            <?php  echo form_open(site_url('library/ebook/index'), array('name' => 'filter', 'id' => 'filter', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                 <select  class="select2_mamun form-control col-md-7 col-xs-12 auto-width" name="school_id" id="school_id_filter" onchange="get_class_by_school(this.value,'')">
                                ...
                                <select  class="select2_mamun form-control col-md-7 col-xs-12 auto-width" name="class_id" id="class_id_filter" onchange="this.form.submit();" >
                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                               
                                </select>
                               <?php echo form_close(); ?> 
                            
                            <?php }else{  ?>
                                <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_ebook_by_class(this.value);">
                               ...
                               <?php echo form_open_multipart(site_url('library/ebook/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="text-info"><?php echo $this->lang->line('dimension'); ?>:- Max-W: 600px, Max-H: 800px</div>
