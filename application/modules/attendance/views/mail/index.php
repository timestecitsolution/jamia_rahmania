<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-envelope-o"></i><small> <?php echo $this->lang->line('manage_absent_email'); ?></small></h3>
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <li class="li-class-list">
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                  
                                <select  class="select2_mamun form-control col-md-7 col-xs-12 auto-width" name="school_id_filter" id="school_id_filter" onchange="get_email_by_school(this.value)">
                                    <option value="<?php echo site_url('attendance/absentemail/index'); ?>">--<?php echo $this->lang->line('select_school'); ?>--</option> 
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('attendance/absentemail/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">  
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="template"  id="fn_template" onchange="get_email_template_by_id(this.value)">
...
<script src="<?php echo VENDOR_URL; ?>datepicker/datepicker.js"></script>
 ...
 <script type="text/javascript">
   ...
   function get_email_template_by_role(role_id, school_id){
         $('#fn_template').html('<option value="">-- <?php echo $this->lang->line('template'); ?>--</option>'); 
        $.ajax({       
            type   : "POST",
