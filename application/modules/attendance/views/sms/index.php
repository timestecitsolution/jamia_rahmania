                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <li class="li-class-list">
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                  
                                <select  class="select2_mamun form-control col-md-7 col-xs-12 auto-width" name="school_id_filter" id="school_id_filter" onchange="get_sms_by_school(this.value)">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('attendance/absentsms/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group display"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="class_id"  id="class_id"  onchange="get_section_by_class(this.value,'');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                ...
                                <div class="item form-group display"> 
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="class_id"><?php echo $this->lang->line('section'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-7 col-xs-12" name="section_id" id="section_id" onchange="get_user('','','',this.value);">                                
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                        </select>
...
<script src="<?php echo VENDOR_URL; ?>datepicker/datepicker.js"></script>
 ...
 <script type="text/javascript">
   ...
   function get_user(role_id, class_id, user_id,section_id){
       ...
       $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('ajax/get_user_by_role_for_absent'); ?>",
            data   : {school_id : school_id, role_id : role_id , class_id: class_id, user_id:user_id, absent_date: absent_date, section_id : section_id},               
            async  : false,
            success: function(response){                                                   
               if(response)
               {
