                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($schools) && !empty($schools)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php } ?>
                                            <td><?php echo $obj->about_title; ?></td>
                                            <td><?php echo $obj->about_text; ?></td>
                                            <td>
                                                <?php  
                                                if (!empty($obj->about_image)) {
                                                    $images = explode(',', $obj->about_image);
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_about">
                            <div class="x_content"> 
                               ...
                               <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="about_title"><?php echo $this->lang->line('title'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" name="about_title" 
                                        placeholder="<?php echo $this->lang->line('title'); ?>" 
                                        value="<?php echo isset($school->about_title) ? $school->about_title : ''; ?>">
                                        <div class="help-block"><?php echo form_error('about_title'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="btn btn-default btn-file">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="about_image[]"  id="about_image" type="file" multiple accept="image/*">
                                        </div>
