                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                             <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_slider_by_school(this.value);">
                            ...
                            <div class="x_content"> 
                               ...
                               <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="text-info"><?php echo $this->lang->line('dimension'); ?>:- Max-W: 1920px, Max-H: 800px</div>
