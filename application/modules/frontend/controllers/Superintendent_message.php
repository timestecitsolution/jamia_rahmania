...
/* * *****************superintendent_message.php**********************************
 * @product name    : Global Multi School Management System Express
 * @type            : Class
 * @class name      : superintendent_message
 * @description     : Manage application superintendent_message text  
...
class Superintendent_message extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        $this->data['muhtamim_message'] = $this->muhtamim->get_single('muhtamim_message', array('designation' => 'muhtamim'));

        $this->layout->title($this->lang->line('muhtamim_message') . ' | ' . SMS);
        $this->layout->view('muhtamim_message/index', $this->data);
    }
    ...
    * ********************************************************** */
    public function edit($id = null) {
        ...
        if(!is_numeric($id)){
            ...
            redirect('frontend/muhtamim_message/index');
        }
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($updated) {    
                    ...
                    create_log('Has been updated a frontend muhtamim message page');
                    
                    success($this->lang->line('update_success'));
                    redirect('frontend/superintendent_message/index');
                } else {
                    error($this->lang->line('update_failed'));
                    redirect('frontend/superintendent_message/edit/' . $this->input->post('id'));
                }
            } else {
                error($this->lang->line('update_failed'));
                $this->data['muhtamim_message'] = $this->muhtamim->get_single('muhtamim_message', array('designation' => 'muhtamim'));
