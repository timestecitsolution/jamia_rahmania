                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                       ...
                       <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                            <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_class_by_school(this.value);">
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_class">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/classes/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="numeric_name"><?php echo $this->lang->line('numeric_name'); ?>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="numeric_name"  id="add_numeric_name" value="<?php echo isset($post['numeric_name']) ?  $post['numeric_name'] : ''; ?>" placeholder="<?php echo $this->lang->line('numeric_name'); ?>"  type="number" autocomplete="off">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/classes/edit/'.$class->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="numeric_name"  id="edit_numeric_name" value="<?php echo isset($class->numeric_name) ?  $class->numeric_name : ''; ?>" placeholder="<?php echo $this->lang->line('numeric_name'); ?>"  type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('numeric_name'); ?></div>
                                    </div>
                                </div>
