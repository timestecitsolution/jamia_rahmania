<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-envelope-o"></i><small> <?php echo $this->lang->line('manage_result_sms'); ?></small></h3>
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                             <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_sms_by_school(this.value);">
                                     <option value="<?php echo site_url('exam/resultsms/index'); ?>">--<?php echo $this->lang->line('select_school'); ?>--</option> 
