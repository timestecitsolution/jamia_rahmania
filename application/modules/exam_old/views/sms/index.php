                ...
                <div class="" data-example-id="togglable-tabs">                    
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                             <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_sms_by_school(this.value);">
                               ...
                               <?php echo form_open_multipart(site_url('exam/text/send'), array('name' => 'sms', 'id' => 'sms', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="exam_id"  id="exam_id" required="required">
                                ...
                                <div class="item form-group"> 
                                 ...
                                 <div class="item form-group display"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="class_id"  id="class_id"  >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                ...
                                <div class="item form-group display"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="section_id"  id="section_id"  >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                ...
                                <div class="item form-group display"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="subject_id"  id="subject_id" onchange="get_user('', this.value,'');" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                            <?php foreach($classes as $obj ){ ?>
                                            <option value="<?php echo $obj->id; ?>" ><?php echo $obj->name; ?></option>
                                            <?php } ?> 
                                ...
                                <div class="item form-group"> 
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="result_type">Result Type <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="result_type"  id="result_type" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                ...
                                <div class="item form-group">  
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="receiver_id"  id="receiver_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                         
                                        </select>
                                 ...
                                 <div class="item form-group">  
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="template"  id="fn_template" onchange="get_template(this.value)">
                                ...
                                <div class="item form-group">  
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">                                       
                                        <select  class="select2_mamun form-control col-md-12 col-xs-12"  name="sms_gateway"  id="sms_gateway" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                              
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('exam/text/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
...
<!-- Super admin js START  -->
 <script type="text/javascript">
    ...
    $('#class_id').on('change', function(){
        ...
        get_subject_by_class(school_id,class_id);
        get_section_by_class(school_id,class_id);
   ...
   function get_user_by_role(role_id){       
    ...
    function get_user(role_id, subject_id){
       ...
       $.ajax({       
            ...
            data   : { school_id: school_id, role_id : role_id , class_id: class_id,section_id:section_id, subject_id:subject_id},               
            async  : false,
            success: function(response){                                                   
               if(response)
               {
   ...
   function get_subject_by_class(school_id,class_id){       
   ...
   function get_section_by_class(school_id,class_id){       
