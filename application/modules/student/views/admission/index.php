                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12" name="religion" id="add_religion">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="Islam" <?php echo isset($admission->religion) && $admission->religion == "Islam" ?  'selected="selected"' : ''; ?>>Islam</option>
                                                <option value="Hiduism" <?php echo isset($admission->religion) && $admission->religion == "Hiduism" ?  'selected="selected"' : ''; ?>>Hiduism</option>
                                                <option value="Christianity" <?php echo isset($admission->religion) && $admission->religion == "Christianity" ?  'selected="selected"' : ''; ?>>Christianity</option>
                                                <option value="Others" <?php echo isset($admission->religion) && $admission->religion == "Others" ?  'selected="selected"' : ''; ?>>Others</option>
                                ...
                                <div class="row">                                      
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <select  class="select2_mamun form-control col-md-7 col-xs-12 quick-field" name="academic_year_id" id="academic_year_id" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <select  class="select2_mamun form-control col-md-7 col-xs-12 quick-field" name="type_id" id="type_id">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <select  class="select2_mamun form-control col-md-7 col-xs-12 quick-field" name="class_id" id="edit_class_id" required="required" disabled="disabled">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($classes as $obj){ ?>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <select  class="select2_mamun form-control col-md-7 col-xs-12" name="gud_religion" id="add_gud_religion">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="Islam" <?php echo isset($admission->gud_religion) && $admission->gud_religion == "Islam" ?  'selected="selected"' : ''; ?>>Islam</option>
                                                <option value="Hiduism" <?php echo isset($admission->gud_religion) && $admission->gud_religion == "Hiduism" ?  'selected="selected"' : ''; ?>>Hiduism</option>
                                                <option value="Christianity" <?php echo isset($admission->gud_religion) && $admission->gud_religion == "Christianity" ?  'selected="selected"' : ''; ?>>Christianity</option>
                                                <option value="Others" <?php echo isset($admission->gud_religion) && $admission->gud_religion == "Others" ?  'selected="selected"' : ''; ?>>Others</option>
