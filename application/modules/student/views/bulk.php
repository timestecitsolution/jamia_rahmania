                                    ...
                                    <?php if($this->session->userdata('role_id') == SUPER_ADMIN){ ?>
                                       ...
                                       <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <select  class="select2_mamun form-control col-md-7 col-xs-12 fn_school_id" name="school_id" id="school_id" required="required" onchange="get_ay_and_class_by_school(this.value);">
                                    ...
                                    <?php } ?>
                                     ...
                                     <div class="col-md-2 col-sm-2 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12" name="section_id" id="section_id" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                            </select>
                                     ...
                                     <div class="col-md-2 col-sm-2 col-xs-12">
                                         <div class="item form-group">
                                             <label for="">&nbsp;</label>
                                            <a style="display: none;"> href="<?php echo ASSET_URL; ?>csv/bulk_student.csv"  class="btn btn-success btn-md"><?php echo $this->lang->line('generate_csv'); ?></a>
                                            <a href="<?php echo ASSET_URL; ?>excel/bulk_student.xlsx"  class="btn btn-success btn-md"><?php echo $this->lang->line('generate_csv'); ?></a>
                                         </div>
                                     </div> 
                                    <div class="col-md-2 col-sm-2 col-xs-12">
                                         <div class="item form-group">
