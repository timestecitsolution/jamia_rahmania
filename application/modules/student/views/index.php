...
if(!empty($students))
{
    ...
    $all_count= count($students);
    if(!empty($sections))
    {
        foreach($sections as $key=>$section)
        {
            $section_id[$key] = 0;
            foreach ($students as $key_val => $value) {
                if($value->section == $section->name)
                {
                    $section_id[$key] = $section_id[$key] + 1;
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php }else{ ?> 
                            ...
                            <?php } ?>
                        <?php } ?>     
                            <li class=""><a href="#tab_trash_student"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-trash"></i> Trash</a> </li>
                        <?php
                            $filter_school_id = 1;
                        ?>
                        <li class="li-class-list">
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>
                                ...
                                <?php echo form_open(site_url('student/index'), array('name' => 'filter', 'id' => 'filter', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    <select  class="select2_mamun form-control col-md-7 col-xs-12" style="width:auto;" name="school_id"  onchange="get_class_by_school(this.value, '');">
                                    ...
                                    <select  class="select2_mamun form-control col-md-7 col-xs-12" id="filter_class_id" name="class_id"  style="width:auto;" onchange="this.form.submit();">
                            ...
                            <?php }else{  ?> 
                                <select  class="select2_mamun form-control col-md-7 col-xs-12" onchange="get_student_by_class(this.value);">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="x_content">
                             <div id="exTab2" class="container"> 
                                        <ul class="nav nav-tabs">
                                            <li class="active">
                                                <a  href="#0" data-toggle="tab">ALL (<?php echo $all_count ?>)</a>
                                            </li>
                                            
                                            <?php
                                            if(!empty($sections))
                                            {
                                                foreach($sections as $key_se => $section) 
                                                {?>
                                                    <li>
                                                        <a href="#<?php echo $section->id; ?>" data-toggle="tab"><?php echo $section->name; ?> (<?php echo $section_id[$key_se] ?>)</a>
                                                    </li>
                                            <?php } }?>
                                        ...
                                        <div class="tab-content ">
                                            <div class="tab-pane active" id="0">
                                                <table id="datatable-responsive" class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                    <thead>
                                                        <tr>
                                                           ...
                                                           <!--   <?php if($this->session->userdata('role_id') == SUPER_ADMIN){ ?>
                                                            ...
                                                            <th><?php echo $this->lang->line('school_student_id'); ?></th>
                                                            <th><?php echo $this->lang->line('group'); ?></th>
                                                            <th><?php echo $this->lang->line('class'); ?></th>
                                                            <th><?php echo $this->lang->line('section'); ?></th>
                                                            <th><?php echo $this->lang->line('roll_no'); ?></th>
                                                            <th><?php echo $this->lang->line('zakat_eligable'); ?></th>
                                                    ...
                                                    <tbody>  
                                                        ...
                                                        <tr style="<?php if($obj->status_type !='regular'){ echo 'background:#f9bfbf; color:#000000;';} ?>">
                                                               ...
                                                               <!--  <td>
                                                                ...
                                                                <td><?php echo $obj->school_student_id; ?></td>
                                                                <td><?php echo $this->lang->line($obj->group); ?></td>
                                                                <td><?php echo $obj->class_name; ?></td>
                                                                <td><?php echo $obj->section; ?></td>
                                                                <td><?php echo $obj->roll_no; ?></td>
                                                                <td><?php 
                                                                    if($obj->zakat_eligable == 1)
                                                                    {
                                                                        echo "হ্যাঁ";
                                                                    }
                                                                    else
                                                                ...
                                                                <td><?php echo $obj->father_phone; ?></td>
                                                                <td><?php echo $obj->mother_phone; ?></td>
                                                                <td>
                                                                   ...
                                                                   <?php if(has_permission(VIEW, 'student', 'student')){ ?>
                                                                    ...
                                                                    <?php if(has_permission(VIEW, 'accounting', 'invoice')){ ?>
                                                                        <a href="<?php echo site_url('student/invoice/'.$obj->id); ?>" class="btn btn-warning btn-xs"><i class="fa fa-dollar"></i> <?php echo $this->lang->line('fee_collection'); ?> </a>
                                                                    <?php } ?>
                                                                     <?php if(has_permission(EDIT, 'student', 'student')){ ?>
                                                                        <select  class="select2_mamun form-control col-md-7 col-xs-12 status-type"  name="status_type"  id="status_type" onchange="update_status_type('<?php echo $obj->id; ?>', this.value);">
                                            ...
                                            if(!empty($sections))
                                            {
                                            foreach($sections as $key_sec=>$section) 
                                            {?>
                                            <div class="tab-pane" id="<?php echo $section->id; ?>">
                                                <table id="datatable-responsive" class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                    <thead>
                                                        <tr>
                                                            <th><?php echo $this->lang->line('sl_no'); ?></th>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_student">
                            <div class="x_content"> 
                                ...
                                <div class="row">                  
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="admission_no"  id="add_admission_no" value="<?php echo isset($x) ?  $x : ''; ?>" placeholder="<?php echo $this->lang->line('admission_no'); ?>" required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="school_student_id"><?php echo $this->lang->line('school_student_id'); ?> <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="school_student_id"  id="add_school_student_id" value="" placeholder="<?php echo $this->lang->line('school_student_id'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('school_student_id'); ?></div> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="dob"  id="add_dob" value="<?php echo isset($post['dob']) ?  $post['dob'] : ''; ?>" placeholder="<?php echo $this->lang->line('birth_date'); ?>"  type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12" style="display: none;">
                                         <div class="item form-group">
                                             <label for="gender"><?php echo $this->lang->line('gender'); ?> <span class="required">*</span></label>
                                              <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="gender"  id="add_gender" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php $genders = get_genders(); $ch_g = 'male';?>
                                                <?php foreach($genders as $key=>$value){ ?>
                                                    <option value="<?php echo $key; ?>" <?php echo isset($ch_g) && $ch_g == $key ?  'selected="selected"' : ''; ?>><?php echo $value; ?></option>
                                                <?php } ?>
                                            </select>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             <label for="blood_group"><?php echo $this->lang->line('blood_group'); ?></label>
                                              <select  class="select2_mamun form-control col-md-7 col-xs-12" name="blood_group" id="add_blood_group">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12" style="display: none;">
                                         <div class="item form-group">
                                              ...
                                              <select  class="select2_mamun form-control col-md-7 col-xs-12 select2_mamun " name="religion" id="add_religion">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="Islam" <?php echo isset($ch_r) && $ch_r == "Islam" ?  'selected="selected"' : ''; ?>>Islam</option>
                                                <option value="Hiduism" <?php echo isset($ch_r) && $ch_r == "Hiduism" ?  'selected="selected"' : ''; ?>>Hiduism</option>
                                                <option value="Christianity" <?php echo isset($ch_r) && $ch_r == "Christianity" ?  'selected="selected"' : ''; ?>>Christianity</option>
                                                <option value="Others" <?php echo isset($ch_r) && $ch_r == "Others" ?  'selected="selected"' : ''; ?>>Others</option>
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12" style="display: none;">
                                         <div class="item form-group">
                                             ...
                                             <input  class="form-control col-md-7 col-xs-12"  name="national_id"  id="add_national_id" value="<?php echo isset($post['national_id']) ?  $post['national_id'] : ''; ?>" placeholder="<?php echo $this->lang->line('national_id'); ?>" type="text" autocomplete="off">
                                ...
                                <div class="row" >  
                                    <div class="col-md-3 col-sm-3 col-xs-12" style="display: none;">
                                         <div class="item form-group">
                                             <label for="type_id"><?php echo $this->lang->line('student_type'); ?></label>
                                                <select  class="select2_mamun form-control col-md-7 col-xs-12" name="type_id" id="add_type_id">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12 quick-field" name="class_id" id="add_class_id" required="required" onchange="get_section_by_class(this.value, '');">
                                               <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                               <?php foreach($classes as $obj){ ?>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                           ...
                                           <select  class="select2_mamun form-control col-md-7 col-xs-12 quick-field" name="section_id" id="add_section_id" required="required" onchange="get_roll_by_section(this.value);">
                                               <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                           </select>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12" name="group" id="add_group">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <input  class="form-control col-md-7 col-xs-12"  name="roll_no"  id="add_roll_no" value="<?php echo isset($post['roll_no']) ?  $post['roll_no'] : ''; ?>" placeholder="<?php echo $this->lang->line('roll_no'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="row"> 
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12" style="display: none;">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="registration_no"  id="add_registration_no" value="<?php echo isset($post['registration_no']) ?  $post['registration_no'] : ''; ?>" placeholder="<?php echo $this->lang->line('registration_no'); ?>" type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12" style="display: none;">
                                         <div class="item form-group">
                                            ...
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12 quick-field" name="discount_id" id="add_discount_id">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12" style="display: none;">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="second_language"  id="add_second_language" value="<?php echo isset($post['second_language']) ?  $post['second_language'] : ''; ?>" placeholder="<?php echo $this->lang->line('second_language'); ?>" type="text" autocomplete="off">
                                ...
                                <div class="row">  
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="father_name"  id="add_father_name" value="<?php echo isset($post['father_name']) ?  $post['father_name'] : ''; ?>" placeholder="<?php echo $this->lang->line('father_name'); ?>" type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12" style="display: none;">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="father_education"  id="add_father_education" value="<?php echo isset($post['father_education']) ?  $post['father_education'] : ''; ?>" placeholder="<?php echo $this->lang->line('father_education'); ?>"  type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12" style="display: none;">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="father_designation"  id="add_father_designation" value="<?php echo isset($post['father_designation']) ?  $post['father_profession'] : ''; ?>" placeholder="<?php echo $this->lang->line('father_designation'); ?>"  type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <div class="btn btn-default btn-file">
                                                ...
                                                <input  class="form-control col-md-7 col-xs-12"  name="father_photo"  id="add_father_photo" type="file">
                                            </div>
                                ...
                                <div class="row">  
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="mother_name"  id="add_mother_name" value="<?php echo isset($post['mother_name']) ?  $post['mother_name'] : ''; ?>" placeholder="<?php echo $this->lang->line('mother_name'); ?>" type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12" style="display: none;">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="mother_education"  id="add_mother_education" value="<?php echo isset($post['mother_education']) ?  $post['mother_education'] : ''; ?>" placeholder="<?php echo $this->lang->line('mother_education'); ?>"  type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12" style="display: none;">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="mother_designation"  id="add_mother_designation" value="<?php echo isset($post['mother_designation']) ?  $post['mother_profession'] : ''; ?>" placeholder="<?php echo $this->lang->line('mother_designation'); ?>"  type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <div class="btn btn-default btn-file">
                                                <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                <input  class="form-control col-md-7 col-xs-12"  name="mother_photo"  id="add_mother_photo" type="file">
                                            </div>
                                            <div class="text-info"><?php echo $this->lang->line('dimension'); ?>:- Max-W: 120px, Max-H: 130px</div>
                                            <div class="text-info"><?php echo $this->lang->line('valid_file_format_img'); ?></div>
                                ...
                                <div class="row"> 
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12 quick-field" name="is_guardian" id="add_is_guardian" required="required" onchange="check_guardian_type(this.value);">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                    ...
                                    <div class="fn_existing_guardian <?php if(isset($post['is_guardian']) && $post['is_guardian'] == 'exist_guardian'){'';}else{ echo 'display'; } ?>">
                                        <div class="col-md-3 col-sm-3 col-xs-12"> 
                                            <div class="item form-group">
                                                ...
                                                <select  class="select2_mamun form-control col-md-7 col-xs-12 quick-field" name="guardian_id" id="add_guardian_id" onchange="get_guardian_by_id(this.value);">
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                    <?php foreach($guardians as $obj){ ?>
                                                        <option value="<?php echo $obj->id; ?>" <?php echo isset($post['guardian_id']) && $post['guardian_id'] == $obj->id ?  'selected="selected"' : ''; ?>><?php echo $obj->name; ?>-<?php echo $obj->phone; ?></option>
                                                    <?php } ?>
                                                </select>
                                    ...
                                    <div class="row"> 
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            ...
                                            <!--     <input  class="form-control col-md-7 col-xs-12"  name="gud_religion"  id="add_gud_religion" value="<?php echo isset($post['gud_religion']) ?  $post['gud_religion'] : ''; ?>" placeholder="<?php echo $this->lang->line('religion'); ?>" type="text"> -->
                                                ...
                                                <select  class="select2_mamun form-control col-md-7 col-xs-12" name="gud_religion" id="add_gud_religion">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="Islam" <?php echo isset($post['gud_religion']) && $post['gud_religion'] == "Islam" ?  'selected="selected"' : ''; ?>>Islam</option>
                                                <option value="Hiduism" <?php echo isset($post['gud_religion']) && $post['gud_religion'] == "Hiduism" ?  'selected="selected"' : ''; ?>>Hiduism</option>
                                                <option value="Christianity" <?php echo isset($post['gud_religion']) && $post['gud_religion'] == "Christianity" ?  'selected="selected"' : ''; ?>>Christianity</option>
                                                <option value="Others" <?php echo isset($post['gud_religion']) && $post['gud_religion'] == "Others" ?  'selected="selected"' : ''; ?>>Others</option>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="gud_password"><?php echo $this->lang->line('password'); ?> <span class="required">*</span></label>
                                                <input  class="form-control col-md-7 col-xs-12"  name="gud_password"  id="add_gud_password" value="<?php echo isset($post['gud_password']) ?  $post['gud_password'] : ''; ?>" placeholder="<?php echo $this->lang->line('password'); ?>"  type="text" >
                                                <div class="help-block"><?php echo form_error('gud_password'); ?></div>
                                            </div>
                                        </div>                                      
                                ...
                                <div class="row"> 
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="previous_school"  id="add_previous_school" value="<?php echo isset($post['previous_school']) ?  $post['previous_school'] : ''; ?>" placeholder="<?php echo $this->lang->line('school_name'); ?>"  type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="previous_class"  id="add_previous_class" value="<?php echo isset($post['previous_class']) ?  $post['previous_class'] : ''; ?>" placeholder="<?php echo $this->lang->line('previous_class'); ?>"  type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <div class="btn btn-default btn-file">
                                                <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                <input  class="form-control col-md-7 col-xs-12"  name="transfer_certificate"  id="add_transfer_certificate" type="file">
                                            </div>
                                            <div class="text-info"><?php echo $this->lang->line('dimension'); ?>:- Max-W: 1200px, Max-H: 600px</div>
                                            <div class="text-info"><?php echo $this->lang->line('valid_file_format_img'); ?></div>
                                ...
                                <div class="row"style="display: none;">
                                 ...
                                 <div class="col-md-3 col-sm-3 col-xs-12">
                                     <div class="item form-group">
                                        ...
                                        <input  class="form-control col-md-7 col-xs-12"  name="username"  id="add_username" value="<?php echo isset($post['username']) ?  $post['username'] : ''; ?>" placeholder="<?php echo $this->lang->line('username'); ?>" required="required" type="text" autocomplete="off">
                                 ...
                                 <div class="col-md-3 col-sm-3 col-xs-12">
                                     <div class="item form-group">
                                        ...
                                        <input  class="form-control col-md-7 col-xs-12"  name="password"  id="add_password" value="123456" placeholder="<?php echo $this->lang->line('password'); ?>" required="required" type="text" autocomplete="off">
                                 ...
                                 <div class="col-md-3 col-sm-3 col-xs-12">
                                     <div class="item form-group">
                                        ...
                                        <input  class="form-control col-md-7 col-xs-12"  name="health_condition"  id="add_health_condition" value="<?php echo isset($post['health_condition']) ?  $post['health_condition'] : ''; ?>" placeholder="<?php echo $this->lang->line('health_condition'); ?>" type="text" autocomplete="off">
                             ...
                             <div class="row" >     
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="zakat_eligable"><?php echo $this->lang->line('zakat_eligable'); ?></label>
                                            <select class="select2_mamun form-control col-md-7 col-xs-12 quick-field" name="zakat_eligable">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="1">হ্যাঁ</option>
                                                <option value="0" >না</option>
                                            </select>
                                            <div class="help-block"><?php echo form_error('zakat_eligable'); ?></div>
                                        </div>
                                    </div>
                                     <div class="col-md-6 col-sm-6 col-xs-12" style="display: none;">
                                         <div class="item form-group">
                                            <label for="other_info"><?php echo $this->lang->line('other_info'); ?></label> 
                                            <textarea  class="form-control col-md-6 col-xs-12 textarea-4column"  name="other_info"  id="add_other_info" placeholder="<?php echo $this->lang->line('other_info'); ?>"><?php echo isset($post['other_info']) ?  $post['other_info'] : ''; ?></textarea>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <div class="btn btn-default btn-file">
                                                <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                <input  class="form-control col-md-7 col-xs-12"  name="photo"  id="add_photo" type="file">
                                            </div>
                                            <div class="text-info"><?php echo $this->lang->line('dimension'); ?>:- Max-W: 120px, Max-H: 130px</div>
                                            <div class="text-info"><?php echo $this->lang->line('valid_file_format_img'); ?></div>
                        ...
                        <div  class="tab-pane fade in " id="tab_trash_student" >
                            <div class="x_content">
                            <table id="datatable-responsive" class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                ...
                                <tbody>  
                                    <?php $guardian_student_data = get_guardian_access_data('student'); ?> 
                                    <?php  $count = 1; if(isset($students_trash) && !empty($students_trash)){ ?>
                                        <?php foreach($students_trash as $obj){ ?>
                                        <?php 
                                            if($this->session->userdata('role_id') == GUARDIAN){
                                                if (!in_array($obj->id, $guardian_student_data)) { continue; }
                                            }elseif($this->session->userdata('role_id') == TEACHER){
                                           ...
                                           <!--  <td>
                                            ...
                                            <td>
                                               ...
                                               <?php if(has_permission(VIEW, 'student', 'student')){ ?>
                                                    ...
                                                    <?php } ?>
                                                <?php if(has_permission(DELETE, 'student', 'student') && $obj->status_type == 'regular'){ ?>
                                                        <br/><a href="<?php echo site_url('student/delete_permanent/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Permanent <?php echo $this->lang->line('delete'); ?> </a>

                                                        <br/><a href="<?php echo site_url('student/delete_restore/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-dark btn-xs"><i class="fa fa-undo"></i> Restore </a>
                                                <?php } ?>
                                                 <?php if(has_permission(EDIT, 'student', 'student')){ ?>
                                                    <select  class="select2_mamun form-control col-md-7 col-xs-12 status-type"  name="status_type"  id="status_type" onchange="update_status_type('<?php echo $obj->id; ?>', this.value);">
                                                        <option value="regular" <?php echo $obj->status_type == 'regular' ?  'selected="selected"' : ''; ?>><?php echo $this->lang->line('regular'); ?></option>
                               ...
                               <div class="row">                  
                                ...
                                <div class="row">                  
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="school_student_id"><?php echo $this->lang->line('school_student_id'); ?> <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="school_student_id"  id="school_student_id" value="<?php echo isset($student->school_student_id) ?  $student->school_student_id : ''; ?>" placeholder="<?php echo $this->lang->line('school_student_id'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('school_student_id'); ?></div> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            <label  for="dob"><?php echo $this->lang->line('birth_date'); ?> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="dob"  id="edit_dob" value="<?php echo isset($student->dob) ?  date('d-m-Y', strtotime($student->dob)) : ''; ?>" placeholder="<?php echo $this->lang->line('birth_date'); ?>"  type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('dob'); ?></div>
                                         </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             <label for="blood_group"><?php echo $this->lang->line('blood_group'); ?></label>
                                              <select  class="select2_mamun form-control col-md-7 col-xs-12" name="blood_group" id="blood_group">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php $bloods = get_blood_group(); ?>
                                                <?php foreach($bloods as $key=>$value){ ?>
                                ...
                                <div class="row">    
                                     <div class="col-md-3 col-sm-3 col-xs-12" style="display: none;">
                                         <div class="item form-group">
                                             <label for="gender"><?php echo $this->lang->line('gender'); ?> <span class="required">*</span></label>
                                              <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="gender"  id="gender" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12" style="display: none;">
                                         <div class="item form-group">
                                              ...
                                              <select  class="select2_mamun form-control col-md-7 col-xs-12" name="religion" id="add_religion">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="Islam" <?php echo isset($post['religion']) && $post['religion'] == "Islam" ?  'selected="selected"' : ''; ?>>Islam</option>
                                                <option value="Hiduism" <?php echo isset($post['religion']) && $post['religion'] == "Hiduism" ?  'selected="selected"' : ''; ?>>Hiduism</option>
                                                <option value="Christianity" <?php echo isset($post['religion']) && $post['religion'] == "Christianity" ?  'selected="selected"' : ''; ?>>Christianity</option>
                                                <option value="Others" <?php echo isset($post['religion']) && $post['religion'] == "Others" ?  'selected="selected"' : ''; ?>>Others</option>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12" style="display: none;">
                                         <div class="item form-group">
                                             <label for="type_id"><?php echo $this->lang->line('student_type'); ?></label>
                                                <select  class="select2_mamun form-control col-md-7 col-xs-12" name="type_id" id="edit_type_id">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($types as $obj){ ?>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            <label for="class_id"><?php echo $this->lang->line('class'); ?> <span class="required">*</span></label>
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12 quick-field" name="class_id" id="edit_class_id" required="required"  onchange="get_section_by_class(this.value, '');">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($classes as $obj){ ?>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            <label for="section_id"><?php echo $this->lang->line('section'); ?> <span class="required">*</span></label>
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12 quick-field" name="section_id" id="edit_section_id" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                            </select>
                                            <div class="help-block"><?php echo form_error('section_id'); ?></div>
                                         </div>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12" >
                                         <div class="item form-group">
                                            <label for="group"><?php echo $this->lang->line('group'); ?> </label>
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12" name="group" id="group">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php $groups = get_groups(); ?>
                                                <?php foreach($groups as $key=>$value){ ?>
                                ...
                                <div class="row"> 
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12" style="display: none;">
                                         <div class="item form-group">
                                            <label for="discount_id"><?php echo $this->lang->line('discount'); ?></label>
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12 quick-field" name="discount_id" id="edit_discount_id">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($discounts as $obj){ ?>                                                    
                                ...
                                <div class="row"> 
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12 quick-field" name="guardian_id" id="edit_guardian_id" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($guardians as $obj){ ?>
                                    ...
                                    {
                                        $guardian_info = get_guardian_by_id($student->guardian_id);
                                    }
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="gud_name"><?php echo $this->lang->line('name'); ?> <span class="required">*</span></label>
                                                <input  class="form-control col-md-7 col-xs-12"  name="gud_name"   value="<?php echo isset($guardian_info->name) ?  $guardian_info->name : ''; ?>" placeholder="<?php echo $this->lang->line('name'); ?>" required="required" type="text">
                                                <div class="help-block"><?php echo form_error('gud_name'); ?></div>
                                            </div>
                                        </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="gud_phone"><?php echo $this->lang->line('phone'); ?> <span class="required">*</span></label>
                                                <input  class="form-control col-md-7 col-xs-12"  name="gud_phone"  value="<?php echo isset($guardian_info->phone) ?  $guardian_info->phone : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?>" required="required" type="text">
                                                <div class="help-block"><?php echo form_error('phone'); ?></div>
                                            </div>
                                    </div>
                                ...
                                <div class="row" style="display: none;">                  
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12"  name="status_type"  id="status_type">
                                ...
                                <div class="row" >     
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select class="select2_mamun form-control col-md-7 col-xs-12 quick-field" name="zakat_eligable">
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                    <option value="1" <?php echo isset($student->zakat_eligable) && $student->zakat_eligable == '1' ? 'selected' : ''; ?>>হ্যাঁ</option>
                                                    <option value="0" <?php echo isset($student->zakat_eligable) && $student->zakat_eligable == '0' ? 'selected' : ''; ?>>না</option>
                                                </select>
                                                <div class="help-block"><?php echo form_error('zakat_eligable'); ?></div>
                                            </div>
                                        </div>
...
<!-- Super admin js START  -->
 <script type="text/javascript">
    ...
    $("document").ready(function() {
         ...
         <?php }elseif(isset ($post) && !empty ($post)){ ?> 
             $("#add_school_id").trigger('change');  
         <?php } ?>

         get_class_by_school(1);


        //  $('#add_phone').on('keyup', function () {
        //     var inputValue = $(this).val(); 
        //     $('#add_gud_username').val('p_' + inputValue); 
        //     $('#add_username').val('s_' + inputValue); 
        // });
        
        $('#add_phone').on('keyup', function () {
            var inputValue = $(this).val(); 
            var admission_no_new = $('#add_admission_no').val(); 
            $('#add_gud_username').val('p_' + admission_no_new + '_' + inputValue); 
            $('#add_username').val('s_' + admission_no_new + '_' + inputValue); 
        });
    });
    ...
    function get_roll_by_section(section_id)
    {       
       ...
       if(!school_id){
        ...
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('ajax/get_roll_by_section'); ?>",
            data   : { school_id:school_id, class_id : class_id , section_id: section_id},               
            async  : false,
            success: function(response){                                                   
               if(response)
