    ...
    <div class="tab-content">
        ...
        <div  class="tab-pane fade in active" id="tab_basic_info" >     
            ...
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <tbody>
                    <tr>
                        <td><img src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $logo; ?>" alt="" width="70" /></td>
                        <td>
                            <?php echo $student->school_name; ?>
                            </br>
                            <?php echo $address; ?>
                        </td>
                        <td><img src="<?php echo UPLOAD_PATH; ?>/student-photo/<?php echo $student->photo; ?>" alt="" width="70" /></td>
                    </tr>
...
<script>
    $(document).ready(function () {
        $('#printButton').on('click', function () {
            var modalContent = $('#tab_basic_info').html();
