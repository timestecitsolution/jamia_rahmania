<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-thumbs-o-up"></i><small> <?php echo $this->lang->line('manage_slider'); ?></small></h3>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(has_permission(ADD, 'subscription', 'slider')){ ?>
                           <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('subscription/slider/add'); ?>" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                            <?php }else{ ?>
                    ...
                    <div class="tab-content">
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($sliders) && !empty($sliders)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(EDIT, 'subscription', 'slider')){ ?>
                                                    <a href="<?php echo site_url('subscription/slider/edit/'.$obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                <?php } ?>                                                
                                                <?php if(has_permission(VIEW, 'subscription', 'slider')){ ?>
                                                ...
                                                <?php  } ?>    
                                                <?php if(has_permission(DELETE, 'subscription', 'slider')){ ?>
                                                    <a href="<?php echo site_url('subscription/slider/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_slider">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('subscription/slider/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                               ...
                               <div class="item form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('subscription/slider/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_slider">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('subscription/slider/edit/'.$slider->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="select2_mamun form-control col-md-7 col-xs-12" name="status" id="edit_status" required="required">
                                                ...
                                                <option value="1" <?php if(isset($slider->status) && $slider->status == '1'){ echo 'selected="selected"'; } ?>><?php echo $this->lang->line('active'); ?></option>                                           
                                                <option value="0" <?php if(isset($slider->status) && $slider->status == '0'){ echo 'selected="selected"'; } ?>><?php echo $this->lang->line('in_active'); ?></option>                                           
                                            </select>
...
<script type="text/javascript">
    ...
    function get_slider_modal(slider_id){
        ...
        $.ajax({       
          type   : "POST",
          url    : "<?php echo site_url('subscription/slider/get_single_slider'); ?>",
